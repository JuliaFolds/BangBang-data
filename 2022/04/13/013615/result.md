...
* Pull request commit: [`2341c97c463c60c8a4605edfdcb2d953c4ce9bf3`](https://github.com/JuliaFolds/BangBang.jl/commit/2341c97c463c60c8a4605edfdcb2d953c4ce9bf3)
...
## Job Properties
* Time of benchmarks:
    - Target: 13 Apr 2022 - 01:32
    - Baseline: 13 Apr 2022 - 01:35
* Package commits:
    - Target: ef7111
    - Baseline: c93fe7
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz      31958 s         13 s       2042 s      82870 s          0 s
       #2  2593 MHz       6874 s         12 s       1399 s     108930 s          0 s
       
  Memory: 6.783611297607422 GB (3055.41796875 MB free)
  Uptime: 1174.0 sec
  Load Avg:  1.02734375  0.78369140625  0.4013671875
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz      38132 s         13 s       2545 s      92187 s          0 s
       #2  2593 MHz      16217 s         12 s       1641 s     115346 s          0 s
       
  Memory: 6.783611297607422 GB (3051.8046875 MB free)
  Uptime: 1334.0 sec
  Load Avg:  1.02734375  0.90283203125  0.5126953125
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake)
```
...
## Job Properties
* Time of benchmark: 13 Apr 2022 - 1:32
* Package commit: ef7111
* Julia commit: 44fa15
...
| `["dataframes", "Categorical"]`                                                             | 514.209 ms (5%) | 77.942 ms | 804.14 MiB (1%) |     4024332 |
...
| `["mergewith", :(:combine => :+), :(:desttype => :compatible), :(:destkeys => :empty)]`     |  44.200 μs (5%) |           |  91.72 KiB (1%) |          14 |
...
## Job Properties
* Time of benchmark: 13 Apr 2022 - 1:35
...
| `["collectors", :(:comp => "filter"), :(:impl => "coll")]`                                  |  50.300 μs (5%) |           | 284.81 KiB (1%) |        5012 |
| `["collectors", :(:comp => "filter"), :(:impl => "nonexpanding")]`                          |  45.500 μs (5%) |           | 312.75 KiB (1%) |        5005 |
...
| `["dataframes", "Categorical"]`                                                             | 582.673 ms (5%) | 89.336 ms | 909.14 MiB (1%) |     5335052 |
