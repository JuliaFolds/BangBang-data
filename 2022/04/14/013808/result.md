...
* Pull request commit: [`404cf53d4feaa7650cf62a20da006f2ac3b0affa`](https://github.com/JuliaFolds/BangBang.jl/commit/404cf53d4feaa7650cf62a20da006f2ac3b0affa)
...
## Job Properties
* Time of benchmarks:
    - Target: 14 Apr 2022 - 01:34
    - Baseline: 14 Apr 2022 - 01:37
* Package commits:
    - Target: 5792c5
    - Baseline: c93fe7
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz      32034 s         16 s       2034 s      27463 s          0 s
       #2  2593 MHz       8236 s         12 s       1679 s      51816 s          0 s
       
  Memory: 6.783611297607422 GB (2814.09375 MB free)
  Uptime: 622.0 sec
  Load Avg:  1.0205078125  0.84912109375  0.47802734375
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz      37537 s         16 s       2436 s      38144 s          0 s
       #2  2593 MHz      19019 s         12 s       2009 s      57302 s          0 s
       
  Memory: 6.783611297607422 GB (2768.8828125 MB free)
  Uptime: 788.0 sec
  Load Avg:  1.0107421875  0.9306640625  0.57470703125
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake)
```
...
## Job Properties
* Time of benchmark: 14 Apr 2022 - 1:34
* Package commit: 5792c5
* Julia commit: 44fa15
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                       | 443.407 μs (5%) |           |                 |             |
...
| `["collectors", :(:comp => "filter"), :(:impl => "nonexpanding")]`                          |  53.101 μs (5%) |           | 312.75 KiB (1%) |        5005 |
| `["collectors", :(:comp => "filter"), :(:impl => "vec")]`                                   |  40.300 μs (5%) |           | 128.59 KiB (1%) |          13 |
| `["collectors", :(:comp => "map"), :(:impl => "coll")]`                                     |   9.801 μs (5%) |           |  78.20 KiB (1%) |           2 |
...
| `["dataframes", "Categorical"]`                                                             | 501.239 ms (5%) | 88.997 ms | 804.14 MiB (1%) |     4024332 |
...
## Job Properties
* Time of benchmark: 14 Apr 2022 - 1:37
...
| `["collectors", :(:comp => "filter"), :(:impl => "vec")]`                                   |  42.200 μs (5%) |            | 128.59 KiB (1%) |          13 |
...
| `["dataframes", "Categorical"]`                                                             | 620.908 ms (5%) | 108.276 ms | 909.14 MiB (1%) |     5335052 |
