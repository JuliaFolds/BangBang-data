...
* Pull request commit: [`2f1e6cf40bf6278062b678fa1303ded09c31d93b`](https://github.com/JuliaFolds/BangBang.jl/commit/2f1e6cf40bf6278062b678fa1303ded09c31d93b)
...
## Job Properties
* Time of benchmarks:
    - Target: 30 Nov 2022 - 01:30
    - Baseline: 30 Nov 2022 - 01:32
* Package commits:
    - Target: bd8cb2
    - Baseline: d70a19
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
       ...
       #1  2793 MHz       9441 s          1 s       1375 s      43377 s          0 s
       #2  2793 MHz      27797 s          0 s       1440 s      24947 s          0 s
       
  Memory: 6.781219482421875 GB (3203.0390625 MB free)
  Uptime: 550.0 sec
  Load Avg:  1.03564453125  0.94873046875  0.5244140625
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
              speed         user         nice          sys         idle          irq
       #1  2793 MHz      12734 s          1 s       1684 s      52364 s          0 s
       #2  2793 MHz      37009 s          0 s       1706 s      28085 s          0 s
       
  Memory: 6.781219482421875 GB (3228.86328125 MB free)
  Uptime: 676.0 sec
  Load Avg:  1.01806640625  0.9814453125  0.5966796875
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake-avx512)
```
...
## Job Properties
* Time of benchmark: 30 Nov 2022 - 1:30
* Package commit: bd8cb2
* Julia commit: 44fa15
...
| `["collectors", :(:comp => "filter"), :(:impl => "coll")]`                                  |  36.699 μs (5%) |           | 284.81 KiB (1%) |        5012 |
...
| `["collectors", :(:comp => "map"), :(:impl => "coll")]`                                     |   4.017 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "man")]`                                      |   4.183 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "safe_coll")]`                                |  12.299 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "vec")]`                                      |  60.400 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                             | 424.295 ms (5%) | 48.294 ms | 804.14 MiB (1%) |     4024332 |
| `["dataframes", "Int-Int"]`                                                                 |   1.085 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                             |   1.464 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-String"]`                                                          |   1.424 ms (5%) |           | 160.27 KiB (1%) |       10252 |
| `["dataframes", "String-String"]`                                                           |   1.382 ms (5%) |           | 160.27 KiB (1%) |       10252 |
...
## Job Properties
* Time of benchmark: 30 Nov 2022 - 1:32
...
| `["collectors", :(:comp => "filter"), :(:impl => "base")]`                                  |  31.700 μs (5%) |           | 128.66 KiB (1%) |          14 |
...
| `["collectors", :(:comp => "map"), :(:impl => "vec")]`                                      |  61.000 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                             | 555.359 ms (5%) | 60.912 ms | 909.14 MiB (1%) |     5335052 |
