...
* Pull request commit: [`63e5aed7d2de57a7868080c71e22ec5f0601b45b`](https://github.com/JuliaFolds/BangBang.jl/commit/63e5aed7d2de57a7868080c71e22ec5f0601b45b)
...
## Job Properties
* Time of benchmarks:
    - Target: 23 Jul 2022 - 01:56
    - Baseline: 23 Jul 2022 - 01:58
* Package commits:
    - Target: 41fbc8
    - Baseline: c93fe7
* Julia commits:
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`       |                1.17 (5%) :x: |                   1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz       8542 s       6684 s       1850 s      27919 s          0 s
       #2  2593 MHz      28088 s       2337 s       2239 s      12705 s          0 s
       
  Memory: 6.780967712402344 GB (926.41015625 MB free)
  Uptime: 456.0 sec
  Load Avg:  1.2373046875  1.04638671875  0.548828125
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz      15658 s       7907 s       2448 s      32169 s          0 s
       #2  2593 MHz      33641 s       3924 s       2633 s      18413 s          0 s
       
  Memory: 6.780967712402344 GB (897.1328125 MB free)
  Uptime: 587.0 sec
  Load Avg:  1.22509765625  1.10498046875  0.64404296875
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake)
```
...
## Job Properties
* Time of benchmark: 23 Jul 2022 - 1:56
* Package commit: 41fbc8
* Julia commit: 44fa15
...
| `["dataframes", "Categorical"]`                                                             | 476.812 ms (5%) | 62.663 ms | 804.14 MiB (1%) |     4024332 |
...
## Job Properties
* Time of benchmark: 23 Jul 2022 - 1:58
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                       | 430.710 μs (5%) |           |                 |             |
...
| `["collectors", :(:comp => "map"), :(:impl => "vec")]`                                      |  61.302 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                             | 564.086 ms (5%) | 85.575 ms | 909.14 MiB (1%) |     5335052 |
...
| `["mergewith", :(:combine => :+), :(:desttype => :compatible), :(:destkeys => :empty)]`     |  35.401 μs (5%) |           |  91.72 KiB (1%) |          14 |
