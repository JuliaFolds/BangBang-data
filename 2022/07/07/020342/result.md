...
* Pull request commit: [`22c40d36df2b5cfa16cd695096c0935545cdc5f6`](https://github.com/JuliaFolds/BangBang.jl/commit/22c40d36df2b5cfa16cd695096c0935545cdc5f6)
...
## Job Properties
* Time of benchmarks:
    - Target: 7 Jul 2022 - 02:00
    - Baseline: 7 Jul 2022 - 02:03
* Package commits:
    - Target: 9d75e4
    - Baseline: c93fe7
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
       ...
       #1  2793 MHz      27198 s         17 s       1469 s      28002 s          0 s
       #2  2793 MHz       8249 s          7 s       1618 s      46878 s          0 s
       
  Memory: 6.783607482910156 GB (3267.81640625 MB free)
  Uptime: 571.0 sec
  Load Avg:  1.001953125  0.7978515625  0.4111328125
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
              speed         user         nice          sys         idle          irq
       #1  2793 MHz      32428 s         17 s       1918 s      35498 s          0 s
       #2  2793 MHz      15656 s          7 s       1823 s      52441 s          0 s
       
  Memory: 6.783607482910156 GB (3291.5078125 MB free)
  Uptime: 703.0 sec
  Load Avg:  0.9892578125  0.86181640625  0.48876953125
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake-avx512)
```
...
## Job Properties
* Time of benchmark: 7 Jul 2022 - 2:0
* Package commit: 9d75e4
* Julia commit: 44fa15
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                       | 487.901 μs (5%) |           |                 |             |
...
| `["dataframes", "Categorical"]`                                                             | 440.913 ms (5%) | 50.384 ms | 804.14 MiB (1%) |     4024332 |
...
| `["dataframes", "String-String"]`                                                           |   1.426 ms (5%) |           | 160.27 KiB (1%) |       10252 |
| `["mergewith", :(:combine => :+), :(:desttype => :compatible), :(:destkeys => :empty)]`     |  23.201 μs (5%) |           |  91.72 KiB (1%) |          14 |
...
## Job Properties
* Time of benchmark: 7 Jul 2022 - 2:3
...
| `["collectors", :(:comp => "filter"), :(:impl => "coll")]`                                  |  38.901 μs (5%) |           | 284.81 KiB (1%) |        5012 |
...
| `["dataframes", "Categorical"]`                                                             | 516.777 ms (5%) | 65.730 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                                 |   1.082 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                             |   1.417 ms (5%) |           | 160.23 KiB (1%) |       10251 |
...
| `["mergewith", :(:combine => :+), :(:desttype => :widen), :(:destkeys => :empty)]`          |  25.400 μs (5%) |           |  92.31 KiB (1%) |          18 |
