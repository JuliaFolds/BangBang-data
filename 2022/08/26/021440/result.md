...
* Pull request commit: [`8e1d6ef38cab5b549232bd66e127345948658658`](https://github.com/JuliaFolds/BangBang.jl/commit/8e1d6ef38cab5b549232bd66e127345948658658)
...
## Job Properties
* Time of benchmarks:
    - Target: 26 Aug 2022 - 02:11
    - Baseline: 26 Aug 2022 - 02:14
* Package commits:
    - Target: d37734
    - Baseline: c93fe7
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz      20732 s          9 s       1220 s      20529 s          0 s
       #2  2593 MHz      15248 s         13 s       2004 s      25705 s          0 s
       
  Memory: 6.781246185302734 GB (3197.796875 MB free)
  Uptime: 433.0 sec
  Load Avg:  1.04296875  0.8046875  0.400390625
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz      31364 s          9 s       1578 s      22924 s          0 s
       #2  2593 MHz      17669 s         13 s       2328 s      36301 s          0 s
       
  Memory: 6.781246185302734 GB (3208.91796875 MB free)
  Uptime: 567.0 sec
  Load Avg:  1.001953125  0.88134765625  0.4873046875
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake)
```
...
## Job Properties
* Time of benchmark: 26 Aug 2022 - 2:11
* Package commit: d37734
* Julia commit: 44fa15
...
| `["dataframes", "Categorical"]`                                                             | 479.335 ms (5%) | 63.521 ms | 804.14 MiB (1%) |     4024332 |
| `["dataframes", "Int-Int"]`                                                                 |   1.096 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                             |   1.580 ms (5%) |           | 160.23 KiB (1%) |       10251 |
...
## Job Properties
* Time of benchmark: 26 Aug 2022 - 2:14
...
| `["collectors", :(:comp => "filter"), :(:impl => "coll")]`                                  |  40.000 μs (5%) |           | 284.81 KiB (1%) |        5012 |
| `["collectors", :(:comp => "filter"), :(:impl => "nonexpanding")]`                          |  43.000 μs (5%) |           | 312.75 KiB (1%) |        5005 |
...
| `["collectors", :(:comp => "map"), :(:impl => "vec")]`                                      |  67.701 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                             | 617.698 ms (5%) | 89.840 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                                 |   1.165 ms (5%) |           | 160.23 KiB (1%) |       10251 |
