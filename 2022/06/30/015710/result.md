...
* Pull request commit: [`06aa2d7d630627e398023877833068565ce78839`](https://github.com/JuliaFolds/BangBang.jl/commit/06aa2d7d630627e398023877833068565ce78839)
...
## Job Properties
* Time of benchmarks:
    - Target: 30 Jun 2022 - 01:54
    - Baseline: 30 Jun 2022 - 01:56
* Package commits:
    - Target: 4d33fd
    - Baseline: c93fe7
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
       ...
       #1  2793 MHz       8097 s          8 s       1256 s      50677 s          0 s
       #2  2793 MHz      26308 s         11 s       1606 s      32278 s          0 s
       
  Memory: 6.783607482910156 GB (3297.09375 MB free)
  Uptime: 605.0 sec
  Load Avg:  1.0  0.7333984375  0.35302734375
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
              speed         user         nice          sys         idle          irq
       #1  2793 MHz      11321 s          8 s       1559 s      59577 s          0 s
       #2  2793 MHz      35192 s         11 s       1873 s      35564 s          0 s
       
  Memory: 6.783607482910156 GB (3282.453125 MB free)
  Uptime: 730.0 sec
  Load Avg:  1.01513671875  0.83837890625  0.44189453125
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake-avx512)
```
...
## Job Properties
* Time of benchmark: 30 Jun 2022 - 1:54
* Package commit: 4d33fd
* Julia commit: 44fa15
...
| `["collectors", :(:comp => "map"), :(:impl => "coll")]`                                     |   3.714 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "man")]`                                      |   3.671 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "safe_coll")]`                                |  12.299 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "vec")]`                                      |  58.999 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                             | 437.871 ms (5%) | 46.534 ms | 804.14 MiB (1%) |     4024332 |
| `["dataframes", "Int-Int"]`                                                                 |   1.074 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                             |   1.428 ms (5%) |           | 160.23 KiB (1%) |       10251 |
...
## Job Properties
* Time of benchmark: 30 Jun 2022 - 1:56
...
| `["collectors", :(:comp => "filter"), :(:impl => "vec")]`                                   |  32.699 μs (5%) |           | 128.59 KiB (1%) |          13 |
...
| `["collectors", :(:comp => "map"), :(:impl => "vec")]`                                      |  62.698 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                             | 561.001 ms (5%) | 57.193 ms | 909.14 MiB (1%) |     5335052 |
...
| `["mergewith", :(:combine => :+), :(:desttype => :compatible), :(:destkeys => :empty)]`     |  22.699 μs (5%) |           |  91.72 KiB (1%) |          14 |
