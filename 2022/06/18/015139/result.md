...
* Pull request commit: [`a739a446b181000dadfdec37c87934e4d8762c49`](https://github.com/JuliaFolds/BangBang.jl/commit/a739a446b181000dadfdec37c87934e4d8762c49)
...
## Job Properties
* Time of benchmarks:
    - Target: 18 Jun 2022 - 01:49
    - Baseline: 18 Jun 2022 - 01:51
* Package commits:
    - Target: 46612a
    - Baseline: c93fe7
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
       ...
       #1  2793 MHz      27840 s          4 s       1626 s      13876 s          0 s
       #2  2793 MHz       6437 s         16 s       1332 s      35659 s          0 s
       
  Memory: 6.783603668212891 GB (3347.953125 MB free)
  Uptime: 437.0 sec
  Load Avg:  1.0  0.79638671875  0.40283203125
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
              speed         user         nice          sys         idle          irq
       #1  2793 MHz      36639 s          4 s       2014 s      17057 s          0 s
       #2  2793 MHz       9622 s         16 s       1536 s      44621 s          0 s
       
  Memory: 6.783603668212891 GB (3367.52734375 MB free)
  Uptime: 561.0 sec
  Load Avg:  0.9892578125  0.8583984375  0.478515625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake-avx512)
```
...
## Job Properties
* Time of benchmark: 18 Jun 2022 - 1:49
* Package commit: 46612a
* Julia commit: 44fa15
...
| `["collectors", :(:comp => "map"), :(:impl => "man")]`                                      |   3.586 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "safe_coll")]`                                |  12.299 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "vec")]`                                      |  59.100 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                             | 427.554 ms (5%) | 43.996 ms | 804.14 MiB (1%) |     4024332 |
...
## Job Properties
* Time of benchmark: 18 Jun 2022 - 1:51
...
|---------------------------------------------------------------------------------------------|----------------:|----------:|----------------:|------------:|
| `["append", "append!!(::SVector, ::SingletonVector)"]`                                      |  12.411 ns (5%) |           |                 |             |
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                       | 487.997 μs (5%) |           |                 |             |
| `["append", "append!!(Empty(SVector), ::SingletonVector)"]`                                 |  12.411 ns (5%) |           |                 |             |
...
| `["dataframes", "Categorical"]`                                                             | 569.804 ms (5%) | 63.963 ms | 909.14 MiB (1%) |     5335052 |
...
| `["mergewith", :(:combine => :+), :(:desttype => :compatible), :(:destkeys => :empty)]`     |  23.099 μs (5%) |           |  91.72 KiB (1%) |          14 |
