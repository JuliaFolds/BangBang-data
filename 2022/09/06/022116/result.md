...
* Pull request commit: [`a78fbc36762c99d6c1c7995a31b9df9a7d5b98ef`](https://github.com/JuliaFolds/BangBang.jl/commit/a78fbc36762c99d6c1c7995a31b9df9a7d5b98ef)
...
## Job Properties
* Time of benchmarks:
    - Target: 6 Sep 2022 - 02:18
    - Baseline: 6 Sep 2022 - 02:20
* Package commits:
    - Target: 99e3b3
    - Baseline: c93fe7
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
       ...
       #1  2793 MHz      28864 s         10 s       1791 s      27310 s          0 s
       #2  2793 MHz       5948 s          9 s       1338 s      50628 s          0 s
       
  Memory: 6.781246185302734 GB (2953.1796875 MB free)
  Uptime: 584.0 sec
  Load Avg:  1.080078125  0.78271484375  0.3935546875
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
              speed         user         nice          sys         idle          irq
       #1  2793 MHz      38741 s         10 s       2212 s      29574 s          0 s
       #2  2793 MHz       8141 s          9 s       1538 s      60800 s          0 s
       
  Memory: 6.781246185302734 GB (2975.1953125 MB free)
  Uptime: 710.0 sec
  Load Avg:  0.99658203125  0.85009765625  0.470703125
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake-avx512)
```
...
## Job Properties
* Time of benchmark: 6 Sep 2022 - 2:18
* Package commit: 99e3b3
* Julia commit: 44fa15
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                       | 484.001 μs (5%) |           |                 |             |
| `["append", "append!!(Empty(SVector), ::SingletonVector)"]`                                 |  12.012 ns (5%) |           |                 |             |
| `["collectors", :(:comp => "filter"), :(:impl => "base")]`                                  |  33.500 μs (5%) |           | 128.66 KiB (1%) |          14 |
...
| `["collectors", :(:comp => "map"), :(:impl => "coll")]`                                     |   4.443 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "man")]`                                      |   4.229 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "safe_coll")]`                                |  12.300 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "vec")]`                                      |  62.800 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                             | 432.908 ms (5%) | 44.301 ms | 804.14 MiB (1%) |     4024332 |
| `["dataframes", "Int-Int"]`                                                                 |   1.093 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                             |   1.414 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-String"]`                                                          |   1.456 ms (5%) |           | 160.27 KiB (1%) |       10252 |
| `["dataframes", "String-String"]`                                                           |   1.425 ms (5%) |           | 160.27 KiB (1%) |       10252 |
...
## Job Properties
* Time of benchmark: 6 Sep 2022 - 2:20
...
| `["mergewith", :(:combine => :right), :(:desttype => :widen), :(:destkeys => :empty)]`      |  24.700 μs (5%) |           |  92.31 KiB (1%) |          18 |
