...
* Pull request commit: [`d5107940b5b1b0b68ce3bbabe82adb325ac4193d`](https://github.com/JuliaFolds/BangBang.jl/commit/d5107940b5b1b0b68ce3bbabe82adb325ac4193d)
...
## Job Properties
* Time of benchmarks:
    - Target: 22 Sep 2022 - 02:11
    - Baseline: 22 Sep 2022 - 02:13
* Package commits:
    - Target: 9e37c9
    - Baseline: df8709
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
       ...
       #1  2793 MHz      27613 s          8 s       1415 s      14799 s          0 s
       #2  2793 MHz       7083 s         12 s       1665 s      35397 s          0 s
       
  Memory: 6.781253814697266 GB (3202.40625 MB free)
  Uptime: 445.0 sec
  Load Avg:  1.080078125  0.7890625  0.39208984375
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
              speed         user         nice          sys         idle          irq
       #1  2793 MHz      31632 s          8 s       1740 s      22815 s          0 s
       #2  2793 MHz      15055 s         12 s       1929 s      39535 s          0 s
       
  Memory: 6.781253814697266 GB (3241.76171875 MB free)
  Uptime: 569.0 sec
  Load Avg:  1.05029296875  0.888671875  0.48046875
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake-avx512)
```
...
## Job Properties
* Time of benchmark: 22 Sep 2022 - 2:11
* Package commit: 9e37c9
* Julia commit: 44fa15
...
| `["collectors", :(:comp => "map"), :(:impl => "coll")]`                                     |   4.329 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "man")]`                                      |   4.471 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "safe_coll")]`                                |  12.299 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "vec")]`                                      |  66.799 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                             | 431.627 ms (5%) | 42.220 ms | 804.14 MiB (1%) |     4024332 |
...
| `["dataframes", "String-String"]`                                                           |   1.388 ms (5%) |           | 160.27 KiB (1%) |       10252 |
| `["mergewith", :(:combine => :+), :(:desttype => :compatible), :(:destkeys => :empty)]`     |  22.099 μs (5%) |           |  91.72 KiB (1%) |          14 |
...
| `["mergewith", :(:combine => :right), :(:desttype => :widen), :(:destkeys => :empty)]`      |  22.799 μs (5%) |           |  92.31 KiB (1%) |          18 |
...
## Job Properties
* Time of benchmark: 22 Sep 2022 - 2:13
...
| `["collectors", :(:comp => "map"), :(:impl => "coll")]`                                     |   4.399 μs (5%) |           |  78.20 KiB (1%) |           2 |
...
| `["dataframes", "Categorical"]`                                                             | 578.367 ms (5%) | 65.408 ms | 909.14 MiB (1%) |     5335052 |
...
| `["mergewith", :(:combine => :right), :(:desttype => :compatible), :(:destkeys => :equal)]` |  12.599 μs (5%) |           |                 |             |
