...
* Pull request commit: [`dae982fc190bbe541e72156ae4717a741fc21ad8`](https://github.com/JuliaFolds/BangBang.jl/commit/dae982fc190bbe541e72156ae4717a741fc21ad8)
...
## Job Properties
* Time of benchmarks:
    - Target: 7 Sep 2022 - 02:13
    - Baseline: 7 Sep 2022 - 02:15
* Package commits:
    - Target: cfc1bc
    - Baseline: c93fe7
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz      10120 s         10 s       1341 s      37268 s          0 s
       #2  2593 MHz      27043 s         11 s       2004 s      20034 s          0 s
       
  Memory: 6.781242370605469 GB (3219.30078125 MB free)
  Uptime: 494.0 sec
  Load Avg:  1.02685546875  0.8388671875  0.4306640625
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz      18294 s         10 s       1755 s      43767 s          0 s
       #2  2593 MHz      32256 s         11 s       2292 s      29624 s          0 s
       
  Memory: 6.781242370605469 GB (3260.66796875 MB free)
  Uptime: 645.0 sec
  Load Avg:  0.97216796875  0.87451171875  0.50732421875
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake)
```
...
## Job Properties
* Time of benchmark: 7 Sep 2022 - 2:13
* Package commit: cfc1bc
* Julia commit: 44fa15
...
| `["dataframes", "Categorical"]`                                                             | 501.813 ms (5%) | 71.595 ms | 804.14 MiB (1%) |     4024332 |
| `["dataframes", "Int-Int"]`                                                                 |   1.118 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                             |   1.602 ms (5%) |           | 160.23 KiB (1%) |       10251 |
...
## Job Properties
* Time of benchmark: 7 Sep 2022 - 2:15
...
| `["dataframes", "Categorical"]`                                                             | 626.539 ms (5%) | 86.081 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                                 |   1.123 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                             |   1.593 ms (5%) |           | 160.23 KiB (1%) |       10251 |
