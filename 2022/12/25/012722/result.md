...
* Pull request commit: [`6d0b50df4d3720b22a9ca776c90e3fe429ff3ed1`](https://github.com/JuliaFolds/BangBang.jl/commit/6d0b50df4d3720b22a9ca776c90e3fe429ff3ed1)
...
## Job Properties
* Time of benchmarks:
    - Target: 25 Dec 2022 - 01:24
    - Baseline: 25 Dec 2022 - 01:26
* Package commits:
    - Target: 8e5f62
    - Baseline: d70a19
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz      29650 s          2 s       1771 s      20445 s          0 s
       #2  2593 MHz       8747 s          2 s       1827 s      40896 s          0 s
       
  Memory: 6.781219482421875 GB (3297.859375 MB free)
  Uptime: 526.0 sec
  Load Avg:  1.14208984375  0.82568359375  0.412109375
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz      32783 s          2 s       2112 s      30064 s          0 s
       #2  2593 MHz      18638 s          2 s       2150 s      43809 s          0 s
       
  Memory: 6.781219482421875 GB (3314.671875 MB free)
  Uptime: 657.0 sec
  Load Avg:  1.013671875  0.89208984375  0.49462890625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake)
```
...
## Job Properties
* Time of benchmark: 25 Dec 2022 - 1:24
* Package commit: 8e5f62
* Julia commit: 44fa15
...
| `["collectors", :(:comp => "map"), :(:impl => "man")]`                                      |   5.425 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "safe_coll")]`                                |  10.601 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "vec")]`                                      |  65.800 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                             | 472.639 ms (5%) | 54.817 ms | 804.14 MiB (1%) |     4024332 |
...
| `["mergewith", :(:combine => :+), :(:desttype => :compatible), :(:destkeys => :half)]`      |  38.900 μs (5%) |           |  68.34 KiB (1%) |           5 |
| `["mergewith", :(:combine => :+), :(:desttype => :widen), :(:destkeys => :empty)]`          |  38.701 μs (5%) |           |  92.31 KiB (1%) |          18 |
...
| `["mergewith", :(:combine => :right), :(:desttype => :compatible), :(:destkeys => :half)]`  |  37.601 μs (5%) |           |  68.34 KiB (1%) |           5 |
| `["mergewith", :(:combine => :right), :(:desttype => :widen), :(:destkeys => :empty)]`      |  41.600 μs (5%) |           |  92.31 KiB (1%) |          18 |
...
## Job Properties
* Time of benchmark: 25 Dec 2022 - 1:26
...
| `["append", "append!!(Empty(SVector), ::SingletonVector)"]`                                 |  11.712 ns (5%) |           |                 |             |
| `["collectors", :(:comp => "filter"), :(:impl => "base")]`                                  |  36.201 μs (5%) |           | 128.66 KiB (1%) |          14 |
...
| `["dataframes", "Categorical"]`                                                             | 607.697 ms (5%) | 73.051 ms | 909.14 MiB (1%) |     5335052 |
