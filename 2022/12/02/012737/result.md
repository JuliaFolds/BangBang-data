...
* Pull request commit: [`dd1fff6097a4558b9c6a4b2e4d98c371ef96250a`](https://github.com/JuliaFolds/BangBang.jl/commit/dd1fff6097a4558b9c6a4b2e4d98c371ef96250a)
...
## Job Properties
* Time of benchmarks:
    - Target: 2 Dec 2022 - 01:24
    - Baseline: 2 Dec 2022 - 01:27
* Package commits:
    - Target: 38a1f8
    - Baseline: d70a19
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
       ...
       #1  2793 MHz       9714 s          0 s       1292 s      44574 s          0 s
       #2  2793 MHz      27620 s          1 s       1418 s      26498 s          0 s
       
  Memory: 6.781219482421875 GB (3419.22265625 MB free)
  Uptime: 563.0 sec
  Load Avg:  1.0  0.76171875  0.38916015625
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
              speed         user         nice          sys         idle          irq
       #1  2793 MHz      14250 s          0 s       1624 s      52450 s          0 s
       #2  2793 MHz      35700 s          1 s       1671 s      30912 s          0 s
       
  Memory: 6.781219482421875 GB (3428.88671875 MB free)
  Uptime: 690.0 sec
  Load Avg:  1.08740234375  0.8984375  0.4912109375
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake-avx512)
```
...
## Job Properties
* Time of benchmark: 2 Dec 2022 - 1:24
* Package commit: 38a1f8
* Julia commit: 44fa15
...
| `["collectors", :(:comp => "filter"), :(:impl => "base")]`                                  |  34.802 μs (5%) |           | 128.66 KiB (1%) |          14 |
...
| `["collectors", :(:comp => "map"), :(:impl => "coll")]`                                     |   4.450 μs (5%) |           |  78.20 KiB (1%) |           2 |
...
| `["dataframes", "Categorical"]`                                                             | 425.239 ms (5%) | 47.465 ms | 804.14 MiB (1%) |     4024332 |
...
| `["mergewith", :(:combine => :+), :(:desttype => :widen), :(:destkeys => :empty)]`          |  23.800 μs (5%) |           |  92.31 KiB (1%) |          18 |
...
## Job Properties
* Time of benchmark: 2 Dec 2022 - 1:27
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                       | 482.696 μs (5%) |           |                 |             |
...
| `["collectors", :(:comp => "map"), :(:impl => "vec")]`                                      |  61.401 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                             | 564.542 ms (5%) | 60.142 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                                 |   1.077 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                             |   1.374 ms (5%) |           | 160.23 KiB (1%) |       10251 |
...
| `["mergewith", :(:combine => :+), :(:desttype => :compatible), :(:destkeys => :half)]`      |  18.400 μs (5%) |           |  68.34 KiB (1%) |           5 |
| `["mergewith", :(:combine => :+), :(:desttype => :widen), :(:destkeys => :empty)]`          |  22.600 μs (5%) |           |  92.31 KiB (1%) |          18 |
| `["mergewith", :(:combine => :right), :(:desttype => :compatible), :(:destkeys => :empty)]` |  21.500 μs (5%) |           |  91.72 KiB (1%) |          14 |
