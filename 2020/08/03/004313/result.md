...
* Pull request commit: [`a0a68257094f6c8f79b0f5cc9530b05ff2bbe2fd`](https://github.com/JuliaFolds/BangBang.jl/commit/a0a68257094f6c8f79b0f5cc9530b05ff2bbe2fd)
...
## Job Properties
* Time of benchmarks:
    - Target: 3 Aug 2020 - 00:40
    - Baseline: 3 Aug 2020 - 00:42
* Package commits:
    - Target: 058708
    - Baseline: fbe363
* Julia commits:
...
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :half"]`      |                1.44 (5%) :x: |                 Inf (1%) :x: |
...
| `["mergewith", ":combine => :right", ":desttype => :compatible", ":destkeys => :half"]`  |                1.55 (5%) :x: |                 Inf (1%) :x: |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz: 
       ...
       #1  2294 MHz      24064 s          0 s       1686 s      11665 s          0 s
       #2  2294 MHz      10240 s          0 s       1670 s      25793 s          0 s
       
  Memory: 6.7648773193359375 GB (2895.828125 MB free)
  Uptime: 392.0 sec
  Load Avg:  1.00390625  0.91796875  0.48681640625
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz: 
              speed         user         nice          sys         idle          irq
       #1  2294 MHz      33420 s          0 s       1968 s      16387 s          0 s
       #2  2294 MHz      15030 s          0 s       1916 s      35114 s          0 s
       
  Memory: 6.7648773193359375 GB (2949.921875 MB free)
  Uptime: 536.0 sec
  Load Avg:  1.01025390625  0.96630859375  0.572265625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, broadwell)
```
...
## Job Properties
* Time of benchmark: 3 Aug 2020 - 0:40
* Package commit: 058708
* Julia commit: 44fa15
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                    | 409.503 μs (5%) |           |                 |             |
...
| `["collectors", ":comp => \"map\"", ":impl => \"man\""]`                                 |   4.333 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"safe_coll\""]`                           |   9.600 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  62.900 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 603.151 ms (5%) | 80.547 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                              | 953.408 μs (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                          |   1.373 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-String"]`                                                       |   1.336 ms (5%) |           | 160.27 KiB (1%) |       10252 |
| `["dataframes", "String-String"]`                                                        |   1.291 ms (5%) |           | 160.27 KiB (1%) |       10252 |
...
## Job Properties
* Time of benchmark: 3 Aug 2020 - 0:42
...
|------------------------------------------------------------------------------------------|----------------:|-----------:|----------------:|------------:|
| `["append", "append!!(::SVector, ::SingletonVector)"]`                                   |  10.300 ns (5%) |            |                 |             |
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                    | 407.708 μs (5%) |            |                 |             |
...
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  62.701 μs (5%) |            | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 881.897 ms (5%) | 105.413 ms | 992.89 MiB (1%) |     6318092 |
| `["dataframes", "Int-Int"]`                                                              | 951.321 μs (5%) |            | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                          |   1.360 ms (5%) |            | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-String"]`                                                       |   1.449 ms (5%) |            | 160.27 KiB (1%) |       10252 |
| `["dataframes", "String-String"]`                                                        |   1.392 ms (5%) |            | 160.27 KiB (1%) |       10252 |
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :empty"]`     |  36.300 μs (5%) |            |  91.72 KiB (1%) |          14 |
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :equal"]`     |  19.700 μs (5%) |            |                 |             |
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :half"]`      |  23.300 μs (5%) |            |                 |             |
...
| `["mergewith", ":combine => :right", ":desttype => :compatible", ":destkeys => :half"]`  |  19.301 μs (5%) |            |                 |             |
