...
* Pull request commit: [`939c7e1e81c84ad0e7a48f60a72e65640c5dc7cb`](https://github.com/JuliaFolds/BangBang.jl/commit/939c7e1e81c84ad0e7a48f60a72e65640c5dc7cb)
...
## Job Properties
* Time of benchmarks:
    - Target: 29 Aug 2020 - 00:27
    - Baseline: 29 Aug 2020 - 00:29
* Package commits:
    - Target: 02ee37
    - Baseline: 17decd
* Julia commits:
...
| `["collectors", ":comp => \"map\"", ":impl => \"coll\""]`                                | 0.78 (5%) :white_check_mark: |                   1.00 (1%)  |
| `["collectors", ":comp => \"map\"", ":impl => \"man\""]`                                 | 0.83 (5%) :white_check_mark: |                   1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz: 
       ...
       #1  2294 MHz       7914 s          0 s       1297 s      57708 s          0 s
       #2  2294 MHz      25962 s          0 s       2021 s      36047 s          0 s
       
  Memory: 6.764881134033203 GB (2877.3671875 MB free)
  Uptime: 736.0 sec
  Load Avg:  1.1318359375  0.94091796875  0.57080078125
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz: 
              speed         user         nice          sys         idle          irq
       #1  2294 MHz      10916 s          0 s       1486 s      68362 s          0 s
       #2  2294 MHz      36607 s          0 s       2344 s      38911 s          0 s
       
  Memory: 6.764881134033203 GB (2873.6640625 MB free)
  Uptime: 875.0 sec
  Load Avg:  1.07763671875  0.994140625  0.6455078125
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, broadwell)
```
...
## Job Properties
* Time of benchmark: 29 Aug 2020 - 0:27
* Package commit: 02ee37
* Julia commit: 44fa15
...
| `["collectors", ":comp => \"map\"", ":impl => \"coll\""]`                                |   4.034 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"man\""]`                                 |   4.733 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"safe_coll\""]`                           |   9.600 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  67.500 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 588.272 ms (5%) | 89.745 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                              | 931.000 μs (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                          |   1.331 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-String"]`                                                       |   1.365 ms (5%) |           | 160.27 KiB (1%) |       10252 |
...
## Job Properties
* Time of benchmark: 29 Aug 2020 - 0:29
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                    | 409.101 μs (5%) |            |                 |             |
...
| `["collectors", ":comp => \"filter\"", ":impl => \"nonexpanding\""]`                     |  42.700 μs (5%) |            | 312.75 KiB (1%) |        5005 |
...
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  69.501 μs (5%) |            | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 835.933 ms (5%) | 110.459 ms | 992.89 MiB (1%) |     6318092 |
| `["dataframes", "Int-Int"]`                                                              | 927.301 μs (5%) |            | 160.23 KiB (1%) |       10251 |
...
| `["mergewith", ":combine => :right", ":desttype => :compatible", ":destkeys => :empty"]` |  39.600 μs (5%) |            |  91.72 KiB (1%) |          14 |
