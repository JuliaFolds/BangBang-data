...
* Pull request commit: [`b944218814ba670ba52fe9a61daa729670edb58d`](https://github.com/JuliaFolds/BangBang.jl/commit/b944218814ba670ba52fe9a61daa729670edb58d)
...
## Job Properties
* Time of benchmarks:
    - Target: 14 Dec 2020 - 00:56
    - Baseline: 14 Dec 2020 - 00:58
* Package commits:
    - Target: bac4fc
    - Baseline: 2070c5
* Julia commits:
...
| `["mergewith", ":combine => :right", ":desttype => :compatible", ":destkeys => :half"]`  |                1.27 (5%) :x: |   1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz      23335 s          0 s       1678 s      19918 s          0 s
       #2  2593 MHz      13323 s          0 s       1351 s      31056 s          0 s
       
  Memory: 6.791393280029297 GB (3508.78125 MB free)
  Uptime: 470.0 sec
  Load Avg:  1.00439453125  0.88916015625  0.47998046875
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz      26138 s          0 s       1943 s      30256 s          0 s
       #2  2593 MHz      23658 s          0 s       1620 s      33879 s          0 s
       
  Memory: 6.791393280029297 GB (3490.7265625 MB free)
  Uptime: 604.0 sec
  Load Avg:  1.07958984375  0.97412109375  0.5703125
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake)
```
...
## Job Properties
* Time of benchmark: 14 Dec 2020 - 0:56
* Package commit: bac4fc
* Julia commit: 44fa15
...
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  67.200 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 544.878 ms (5%) | 69.786 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                              |   1.127 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                          |   1.604 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-String"]`                                                       |   1.583 ms (5%) |           | 160.27 KiB (1%) |       10252 |
...
## Job Properties
* Time of benchmark: 14 Dec 2020 - 0:58
...
|------------------------------------------------------------------------------------------|----------------:|----------:|----------------:|------------:|
| `["append", "append!!(::SVector, ::SingletonVector)"]`                                   |  11.712 ns (5%) |           |                 |             |
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                    | 509.008 μs (5%) |           |                 |             |
| `["append", "append!!(Empty(SVector), ::SingletonVector)"]`                              |  11.712 ns (5%) |           |                 |             |
...
| `["dataframes", "Categorical"]`                                                          | 612.004 ms (5%) | 73.968 ms | 909.14 MiB (1%) |     5335052 |
...
| `["dataframes", "String-String"]`                                                        |   1.512 ms (5%) |           | 160.27 KiB (1%) |       10252 |
