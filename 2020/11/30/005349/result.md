...
## Job Properties
* Time of benchmark: 30 Nov 2020 - 0:51
* Package commit: 763cb9
* Julia commit: 44fa15
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                    | 408.202 μs (5%) |           |                 |             |
...
| `["collectors", ":comp => \"map\"", ":impl => \"coll\""]`                                |   4.233 μs (5%) |           |  78.20 KiB (1%) |           2 |
...
| `["dataframes", "Categorical"]`                                                          | 603.329 ms (5%) | 81.815 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                              | 938.306 μs (5%) |           | 160.23 KiB (1%) |       10251 |
...
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :half"]`      |  31.100 μs (5%) |           |  68.34 KiB (1%) |           5 |
| `["mergewith", ":combine => :+", ":desttype => :widen", ":destkeys => :empty"]`          |  37.101 μs (5%) |           |  92.31 KiB (1%) |          18 |
