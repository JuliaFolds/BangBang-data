...
* Pull request commit: [`c6de957c7a638bf20f8fd935e34f39f853cc28e8`](https://github.com/JuliaFolds/BangBang.jl/commit/c6de957c7a638bf20f8fd935e34f39f853cc28e8)
...
## Job Properties
* Time of benchmarks:
    - Target: 17 Nov 2020 - 00:44
    - Baseline: 17 Nov 2020 - 00:47
* Package commits:
    - Target: 7c3d7f
    - Baseline: 2070c5
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz: 
       ...
       #1  2294 MHz      32331 s          0 s       1721 s      18537 s          0 s
       #2  2294 MHz       9016 s          0 s       1729 s      42017 s          0 s
       
  Memory: 6.791393280029297 GB (3455.3046875 MB free)
  Uptime: 545.0 sec
  Load Avg:  1.09765625  0.99365234375  0.5732421875
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz: 
              speed         user         nice          sys         idle          irq
       #1  2294 MHz      44596 s          0 s       2106 s      20888 s          0 s
       #2  2294 MHz      11401 s          0 s       1925 s      54407 s          0 s
       
  Memory: 6.791393280029297 GB (3456.875 MB free)
  Uptime: 695.0 sec
  Load Avg:  1.0048828125  1.0  0.64453125
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, broadwell)
```
...
## Job Properties
* Time of benchmark: 17 Nov 2020 - 0:44
* Package commit: 7c3d7f
* Julia commit: 44fa15
...
|------------------------------------------------------------------------------------------|----------------:|----------:|----------------:|------------:|
| `["append", "append!!(::SVector, ::SingletonVector)"]`                                   |  10.700 ns (5%) |           |                 |             |
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                    | 456.202 μs (5%) |           |                 |             |
| `["append", "append!!(Empty(SVector), ::SingletonVector)"]`                              |  10.900 ns (5%) |           |                 |             |
...
| `["collectors", ":comp => \"filter\"", ":impl => \"vec\""]`                              |  47.100 μs (5%) |           | 128.59 KiB (1%) |          13 |
| `["collectors", ":comp => \"map\"", ":impl => \"coll\""]`                                |   7.420 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"man\""]`                                 |   4.880 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"safe_coll\""]`                           |   9.900 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  69.200 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 679.390 ms (5%) | 92.958 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                              |   1.061 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                          |   1.500 ms (5%) |           | 160.23 KiB (1%) |       10251 |
...
## Job Properties
* Time of benchmark: 17 Nov 2020 - 0:47
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                    | 454.401 μs (5%) |           |                 |             |
...
| `["dataframes", "Categorical"]`                                                          | 749.353 ms (5%) | 94.807 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                              |   1.065 ms (5%) |           | 160.23 KiB (1%) |       10251 |
