...
## Job Properties
* Time of benchmark: 11 Sep 2020 - 2:32
* Package commit: 9f4e29
* Julia commit: 44fa15
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                    | 559.308 μs (5%) |           |                 |             |
| `["append", "append!!(Empty(SVector), ::SingletonVector)"]`                              |  12.613 ns (5%) |           |                 |             |
| `["collectors", ":comp => \"filter\"", ":impl => \"base\""]`                             |  40.901 μs (5%) |           | 128.66 KiB (1%) |          14 |
...
| `["collectors", ":comp => \"map\"", ":impl => \"coll\""]`                                |   5.467 μs (5%) |           |  78.20 KiB (1%) |           2 |
...
| `["dataframes", "Categorical"]`                                                          | 590.399 ms (5%) | 71.980 ms | 909.14 MiB (1%) |     5335052 |
...
| `["dataframes", "String-String"]`                                                        |   1.632 ms (5%) |           | 160.27 KiB (1%) |       10252 |
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :empty"]`     |  47.601 μs (5%) |           |  91.72 KiB (1%) |          14 |
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :equal"]`     |  27.800 μs (5%) |           |                 |             |
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :half"]`      |  43.101 μs (5%) |           |  68.34 KiB (1%) |           5 |
