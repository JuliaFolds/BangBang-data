...
## Job Properties
* Time of benchmark: 21 Jul 2020 - 0:37
* Package commit: e382db
* Julia commit: 44fa15
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                    | 560.520 μs (5%) |           |                 |             |
| `["append", "append!!(Empty(SVector), ::SingletonVector)"]`                              |  14.000 ns (5%) |           |                 |             |
| `["collectors", ":comp => \"filter\"", ":impl => \"base\""]`                             |  43.301 μs (5%) |           | 128.66 KiB (1%) |          14 |
...
| `["collectors", ":comp => \"filter\"", ":impl => \"vec\""]`                              |  43.501 μs (5%) |           | 128.59 KiB (1%) |          13 |
...
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  76.903 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 630.584 ms (5%) | 75.829 ms | 909.14 MiB (1%) |     5335052 |
...
| `["dataframes", "String-String"]`                                                        |   1.635 ms (5%) |           | 160.27 KiB (1%) |       10252 |
...
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :half"]`      |  41.001 μs (5%) |           |  68.34 KiB (1%) |           5 |
| `["mergewith", ":combine => :+", ":desttype => :widen", ":destkeys => :empty"]`          |  46.802 μs (5%) |           |  92.31 KiB (1%) |          18 |
| `["mergewith", ":combine => :right", ":desttype => :compatible", ":destkeys => :empty"]` |  39.602 μs (5%) |           |  91.72 KiB (1%) |          14 |
