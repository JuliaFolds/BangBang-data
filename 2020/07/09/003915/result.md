...
* Pull request commit: [`5eee0d3d2698081e898b9ab99511f83f5d589dfa`](https://github.com/JuliaFolds/BangBang.jl/commit/5eee0d3d2698081e898b9ab99511f83f5d589dfa)
...
## Job Properties
* Time of benchmarks:
    - Target: 9 Jul 2020 - 00:36
    - Baseline: 9 Jul 2020 - 00:38
* Package commits:
    - Target: 400f9d
    - Baseline: ce35fa
* Julia commits:
...
| `["collectors", ":comp => \"map\"", ":impl => \"man\""]`                                 | 0.63 (5%) :white_check_mark: |                   1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz: 
       ...
       #1  2294 MHz      13973 s          0 s       1812 s      33411 s          0 s
       #2  2294 MHz      22434 s          0 s       1804 s      25395 s          0 s
       
  Memory: 6.764884948730469 GB (2844.0859375 MB free)
  Uptime: 511.0 sec
  Load Avg:  1.0  0.87841796875  0.482421875
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz: 
              speed         user         nice          sys         idle          irq
       #1  2294 MHz      25248 s          0 s       2138 s      37477 s          0 s
       #2  2294 MHz      26685 s          0 s       2039 s      36563 s          0 s
       
  Memory: 6.764884948730469 GB (2893.3671875 MB free)
  Uptime: 668.0 sec
  Load Avg:  1.0458984375  0.9716796875  0.5849609375
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, broadwell)
```
...
## Job Properties
* Time of benchmark: 9 Jul 2020 - 0:36
* Package commit: 400f9d
* Julia commit: 44fa15
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                    | 456.105 μs (5%) |           |                 |             |
...
| `["collectors", ":comp => \"filter\"", ":impl => \"nonexpanding\""]`                     |  39.200 μs (5%) |           | 312.75 KiB (1%) |        5005 |
| `["collectors", ":comp => \"filter\"", ":impl => \"vec\""]`                              |  45.100 μs (5%) |           | 128.59 KiB (1%) |          13 |
| `["collectors", ":comp => \"map\"", ":impl => \"coll\""]`                                |   6.360 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"man\""]`                                 |   4.220 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"safe_coll\""]`                           |  10.300 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  75.201 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 711.895 ms (5%) | 97.241 ms | 909.14 MiB (1%) |     5335052 |
...
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :empty"]`     |  46.600 μs (5%) |           |  91.72 KiB (1%) |          14 |
...
## Job Properties
* Time of benchmark: 9 Jul 2020 - 0:38
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                    | 444.702 μs (5%) |            |                 |             |
...
| `["dataframes", "Categorical"]`                                                          | 992.542 ms (5%) | 123.278 ms | 992.89 MiB (1%) |     6318092 |
| `["dataframes", "Int-Int"]`                                                              |   1.037 ms (5%) |            | 160.23 KiB (1%) |       10251 |
...
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :empty"]`     |  49.500 μs (5%) |            |  91.72 KiB (1%) |          14 |
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :equal"]`     |  20.300 μs (5%) |            |                 |             |
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :half"]`      |  41.200 μs (5%) |            |  68.34 KiB (1%) |           5 |
