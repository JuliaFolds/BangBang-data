...
* Pull request commit: [`dfbf81afc013bb1b256ea9679bc4251e64282f9d`](https://github.com/JuliaFolds/BangBang.jl/commit/dfbf81afc013bb1b256ea9679bc4251e64282f9d)
* Pull request: <https://github.com/JuliaFolds/BangBang.jl/pull/175> (Add __appendto!!__)
...
| `["collectors", ":comp => \"filter\"", ":impl => \"vec\""]`                              | 0.85 (5%) :white_check_mark: |   1.00 (1%)  |
| `["collectors", ":comp => \"map\"", ":impl => \"coll\""]`                                | 0.66 (5%) :white_check_mark: |   1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz: 
       ...
       #1  2294 MHz      20927 s          0 s       1596 s      15117 s          0 s
       #2  2294 MHz      13153 s          0 s       1633 s      22548 s          0 s
       
  Memory: 6.764884948730469 GB (3127.03125 MB free)
  Uptime: 391.0 sec
  Load Avg:  1.09228515625  0.87939453125  0.44140625
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz: 
              speed         user         nice          sys         idle          irq
       #1  2294 MHz      22874 s          0 s       1652 s      23423 s          0 s
       #2  2294 MHz      21484 s          0 s       1755 s      24412 s          0 s
       
  Memory: 6.764884948730469 GB (3104.796875 MB free)
  Uptime: 495.0 sec
  Load Avg:  1.046875  0.9306640625  0.50732421875
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, broadwell)
```
...
| `["collectors", ":comp => \"map\"", ":impl => \"man\""]`                                 |   5.543 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"safe_coll\""]`                           |   8.900 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  58.500 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 747.386 ms (5%) | 89.394 ms | 992.89 MiB (1%) |     6318092 |
| `["dataframes", "Int-Int"]`                                                              | 984.802 μs (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                          |   1.334 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-String"]`                                                       |   1.335 ms (5%) |           | 160.27 KiB (1%) |       10252 |
| `["dataframes", "String-String"]`                                                        |   1.275 ms (5%) |           | 160.27 KiB (1%) |       10252 |
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                    | 591.902 μs (5%) |            |                 |             |
...
| `["dataframes", "Categorical"]`                                                          | 908.186 ms (5%) | 100.510 ms | 992.89 MiB (1%) |     6318092 |
| `["dataframes", "Int-Int"]`                                                              | 984.703 μs (5%) |            | 160.23 KiB (1%) |       10251 |
