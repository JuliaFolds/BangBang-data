...
* Pull request commit: [`ffcb13f78f2a8886dbc3cca9c5d6424436badb7d`](https://github.com/JuliaFolds/BangBang.jl/commit/ffcb13f78f2a8886dbc3cca9c5d6424436badb7d)
...
|------------------------------------------------------------------------------------------|------------------------------|------------------------------|
| `["collectors", ":comp => \"map\"", ":impl => \"man\""]`                                 | 0.67 (5%) :white_check_mark: |                   1.00 (1%)  |
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |                1.05 (5%) :x: |                   1.00 (1%)  |
| `["dataframes", "Categorical"]`                                                          | 0.66 (5%) :white_check_mark: | 0.92 (1%) :white_check_mark: |
| `["dataframes", "Missing-String"]`                                                       |                1.05 (5%) :x: |                   1.00 (1%)  |
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :empty"]`     |                1.12 (5%) :x: |                   1.00 (1%)  |
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :half"]`      |                1.15 (5%) :x: |                   1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz: 
       ...
       #1  2294 MHz      15992 s          0 s       1577 s      24268 s          0 s
       #2  2294 MHz      18353 s          0 s       1664 s      22597 s          0 s
       
  Memory: 6.764884948730469 GB (2971.33984375 MB free)
  Uptime: 438.0 sec
  Load Avg:  1.0107421875  0.81591796875  0.42236328125
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz: 
              speed         user         nice          sys         idle          irq
       #1  2294 MHz      27068 s          0 s       1901 s      27040 s          0 s
       #2  2294 MHz      21332 s          0 s       1864 s      33601 s          0 s
       
  Memory: 6.764884948730469 GB (3005.6640625 MB free)
  Uptime: 581.0 sec
  Load Avg:  1.0693359375  0.9296875  0.52734375
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, broadwell)
```
...
## Job Properties
* Time of benchmark: 6 Jul 2020 - 0:36
* Package commit: a9ab66
* Julia commit: 44fa15
...
| `["collectors", ":comp => \"map\"", ":impl => \"man\""]`                                 |   4.020 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"safe_coll\""]`                           |   9.100 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  61.800 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 631.904 ms (5%) | 86.263 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                              | 918.002 μs (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                          |   1.296 ms (5%) |           | 160.23 KiB (1%) |       10251 |
...
| `["dataframes", "Categorical"]`                                                          | 957.699 ms (5%) | 108.622 ms | 992.89 MiB (1%) |     6318092 |
| `["dataframes", "Int-Int"]`                                                              | 944.602 μs (5%) |            | 160.23 KiB (1%) |       10251 |
...
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :half"]`      |  27.300 μs (5%) |            |  68.34 KiB (1%) |           5 |
...
| `["mergewith", ":combine => :right", ":desttype => :widen", ":destkeys => :empty"]`      |  40.800 μs (5%) |            |  92.31 KiB (1%) |          18 |
