...
## Job Properties
* Time of benchmark: 7 Oct 2020 - 0:55
* Package commit: a21d04
* Julia commit: 44fa15
...
| `["collectors", ":comp => \"map\"", ":impl => \"coll\""]`                                |   5.580 μs (5%) |           |  78.20 KiB (1%) |           2 |
...
| `["dataframes", "Categorical"]`                                                          | 625.529 ms (5%) | 83.042 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                              | 927.810 μs (5%) |           | 160.23 KiB (1%) |       10251 |
...
| `["mergewith", ":combine => :+", ":desttype => :widen", ":destkeys => :empty"]`          |  41.601 μs (5%) |           |  92.31 KiB (1%) |          18 |
