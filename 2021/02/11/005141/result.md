...
* Pull request commit: [`407d1a97fff2d9344a22cb432c95351b0aae428a`](https://github.com/JuliaFolds/BangBang.jl/commit/407d1a97fff2d9344a22cb432c95351b0aae428a)
...
## Job Properties
* Time of benchmarks:
    - Target: 11 Feb 2021 - 00:49
    - Baseline: 11 Feb 2021 - 00:51
* Package commits:
    - Target: 4f9965
    - Baseline: eecbf8
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz      22629 s          0 s       1393 s      14668 s          0 s
       #2  2593 MHz      13248 s          0 s       1409 s      24499 s          0 s
       
  Memory: 6.791393280029297 GB (3380.46484375 MB free)
  Uptime: 406.0 sec
  Load Avg:  1.0  0.85986328125  0.44970703125
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz      31182 s          0 s       1644 s      18746 s          0 s
       #2  2593 MHz      17366 s          0 s       1695 s      32968 s          0 s
       
  Memory: 6.791393280029297 GB (3388.58984375 MB free)
  Uptime: 535.0 sec
  Load Avg:  1.052734375  0.94091796875  0.53466796875
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake)
```
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                    | 511.301 μs (5%) |           |                 |             |
...
| `["collectors", ":comp => \"map\"", ":impl => \"man\""]`                                 |   5.140 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"safe_coll\""]`                           |  10.500 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  64.600 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 507.715 ms (5%) | 51.340 ms | 909.14 MiB (1%) |     5335052 |
...
## Job Properties
* Time of benchmark: 11 Feb 2021 - 0:51
...
| `["dataframes", "Categorical"]`                                                          | 541.057 ms (5%) | 56.032 ms | 909.14 MiB (1%) |     5335052 |
