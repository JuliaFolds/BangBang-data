...
* Pull request commit: [`70128a0e4f24bd6bf2dbfd27d88040c09cf9f724`](https://github.com/JuliaFolds/BangBang.jl/commit/70128a0e4f24bd6bf2dbfd27d88040c09cf9f724)
...
## Job Properties
* Time of benchmarks:
    - Target: 14 Feb 2021 - 00:52
    - Baseline: 14 Feb 2021 - 00:54
* Package commits:
    - Target: dd457a
    - Baseline: eecbf8
* Julia commits:
...
| `["mergewith", ":combine => :right", ":desttype => :compatible", ":destkeys => :equal"]` | 0.87 (5%) :white_check_mark: |   1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz: 
       ...
       #1  2294 MHz      10054 s          0 s       1284 s      34338 s          0 s
       #2  2294 MHz      32152 s          0 s       2291 s      11398 s          0 s
       
  Memory: 6.791393280029297 GB (3419.8984375 MB free)
  Uptime: 472.0 sec
  Load Avg:  1.02294921875  0.9189453125  0.49658203125
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz: 
              speed         user         nice          sys         idle          irq
       #1  2294 MHz      21649 s          0 s       1697 s      37695 s          0 s
       #2  2294 MHz      35564 s          0 s       2528 s      23092 s          0 s
       
  Memory: 6.791393280029297 GB (3394.21875 MB free)
  Uptime: 626.0 sec
  Load Avg:  1.00634765625  0.9677734375  0.5849609375
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, broadwell)
```
...
## Job Properties
* Time of benchmark: 14 Feb 2021 - 0:52
* Package commit: dd457a
* Julia commit: 44fa15
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                    | 429.201 μs (5%) |           |                 |             |
...
| `["collectors", ":comp => \"filter\"", ":impl => \"nonexpanding\""]`                     |  38.600 μs (5%) |           | 312.75 KiB (1%) |        5005 |
| `["collectors", ":comp => \"filter\"", ":impl => \"vec\""]`                              |  39.600 μs (5%) |           | 128.59 KiB (1%) |          13 |
| `["collectors", ":comp => \"map\"", ":impl => \"coll\""]`                                |   4.533 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"man\""]`                                 |   5.034 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"safe_coll\""]`                           |   9.700 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  70.200 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 661.283 ms (5%) | 91.794 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                              |   1.001 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                          |   1.388 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-String"]`                                                       |   1.436 ms (5%) |           | 160.27 KiB (1%) |       10252 |
| `["dataframes", "String-String"]`                                                        |   1.384 ms (5%) |           | 160.27 KiB (1%) |       10252 |
...
| `["mergewith", ":combine => :right", ":desttype => :widen", ":destkeys => :empty"]`      |  44.300 μs (5%) |           |  92.31 KiB (1%) |          18 |
...
## Job Properties
* Time of benchmark: 14 Feb 2021 - 0:54
...
| `["dataframes", "Categorical"]`                                                          | 723.672 ms (5%) | 85.709 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                              |   1.010 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                          |   1.352 ms (5%) |           | 160.23 KiB (1%) |       10251 |
...
| `["mergewith", ":combine => :right", ":desttype => :compatible", ":destkeys => :half"]`  |  36.900 μs (5%) |           |  68.34 KiB (1%) |           5 |
