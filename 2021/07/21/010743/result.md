...
* Pull request commit: [`3936d24d88373ba079f098d39f2e0e2b52ae0331`](https://github.com/JuliaFolds/BangBang.jl/commit/3936d24d88373ba079f098d39f2e0e2b52ae0331)
...
## Job Properties
* Time of benchmarks:
    - Target: 21 Jul 2021 - 01:04
    - Baseline: 21 Jul 2021 - 01:07
* Package commits:
    - Target: 3561a3
    - Baseline: a10491
* Julia commits:
...
|------------------------------------------------------------------------------------------|------------------------------|------------------------------|
| `["append", "append!!(::SVector, ::SingletonVector)"]`                                   | 0.78 (5%) :white_check_mark: |                   1.00 (1%)  |
...
| `["dataframes", "Categorical"]`                                                          | 0.81 (5%) :white_check_mark: | 0.98 (1%) :white_check_mark: |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz: 
       ...
       #1  2294 MHz      28569 s         14 s       1559 s      33072 s          0 s
       #2  2294 MHz      10641 s         10 s       1775 s      50905 s          0 s
       
  Memory: 6.790924072265625 GB (3275.55859375 MB free)
  Uptime: 639.0 sec
  Load Avg:  1.04296875  0.78662109375  0.38525390625
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz: 
              speed         user         nice          sys         idle          irq
       #1  2294 MHz      31781 s         14 s       1797 s      44303 s          0 s
       #2  2294 MHz      21767 s         10 s       2174 s      54082 s          0 s
       
  Memory: 6.790924072265625 GB (3266.29296875 MB free)
  Uptime: 786.0 sec
  Load Avg:  1.01123046875  0.88720703125  0.48779296875
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, broadwell)
```
...
## Job Properties
* Time of benchmark: 21 Jul 2021 - 1:4
* Package commit: 3561a3
* Julia commit: 44fa15
...
| `["collectors", ":comp => \"map\"", ":impl => \"man\""]`                                 |   4.217 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"safe_coll\""]`                           |   8.800 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  63.800 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 534.472 ms (5%) | 70.813 ms | 889.14 MiB (1%) |     4925452 |
| `["dataframes", "Int-Int"]`                                                              | 936.010 μs (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                          |   1.288 ms (5%) |           | 160.23 KiB (1%) |       10251 |
...
| `["mergewith", ":combine => :right", ":desttype => :compatible", ":destkeys => :half"]`  |  28.600 μs (5%) |           |  68.34 KiB (1%) |           5 |
...
## Job Properties
* Time of benchmark: 21 Jul 2021 - 1:7
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                    | 408.805 μs (5%) |           |                 |             |
...
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  60.301 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 662.773 ms (5%) | 78.252 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                              | 925.510 μs (5%) |           | 160.23 KiB (1%) |       10251 |
...
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :half"]`      |  28.901 μs (5%) |           |  68.34 KiB (1%) |           5 |
