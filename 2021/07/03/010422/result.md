...
| `["mergewith", ":combine => :right", ":desttype => :compatible", ":destkeys => :equal"]` |                1.24 (5%) :x: |                   1.00 (1%)  |
...
## Job Properties
* Time of benchmark: 3 Jul 2021 - 1:1
* Package commit: 34411e
* Julia commit: 44fa15
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                    | 486.529 μs (5%) |           |                 |             |
| `["append", "append!!(Empty(SVector), ::SingletonVector)"]`                              |  12.625 ns (5%) |           |                 |             |
| `["collectors", ":comp => \"filter\"", ":impl => \"base\""]`                             |  43.802 μs (5%) |           | 128.66 KiB (1%) |          14 |
| `["collectors", ":comp => \"filter\"", ":impl => \"coll\""]`                             |  49.903 μs (5%) |           | 284.81 KiB (1%) |        5012 |
| `["collectors", ":comp => \"filter\"", ":impl => \"nonexpanding\""]`                     |  43.603 μs (5%) |           | 312.75 KiB (1%) |        5005 |
| `["collectors", ":comp => \"filter\"", ":impl => \"vec\""]`                              |  43.102 μs (5%) |           | 128.59 KiB (1%) |          13 |
...
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  75.205 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 609.184 ms (5%) | 73.197 ms | 889.14 MiB (1%) |     4925452 |
| `["dataframes", "Int-Int"]`                                                              |   1.236 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                          |   1.738 ms (5%) |           | 160.23 KiB (1%) |       10251 |
...
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :equal"]`     |  24.302 μs (5%) |           |                 |             |
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :half"]`      |  40.102 μs (5%) |           |  68.34 KiB (1%) |           5 |
...
| `["mergewith", ":combine => :right", ":desttype => :compatible", ":destkeys => :equal"]` |  25.701 μs (5%) |           |                 |             |
