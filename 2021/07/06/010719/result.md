...
* Pull request commit: [`65e942cd64ca7af7fa751a34b290ba8fd6b7f415`](https://github.com/JuliaFolds/BangBang.jl/commit/65e942cd64ca7af7fa751a34b290ba8fd6b7f415)
...
## Job Properties
* Time of benchmarks:
    - Target: 6 Jul 2021 - 01:04
    - Baseline: 6 Jul 2021 - 01:06
* Package commits:
    - Target: cd02d0
    - Baseline: a10491
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz      29904 s         10 s       1568 s      15972 s          0 s
       #2  2593 MHz       6234 s         12 s       1173 s      40100 s          0 s
       
  Memory: 6.790924072265625 GB (3448.88671875 MB free)
  Uptime: 480.0 sec
  Load Avg:  1.0  0.78564453125  0.40087890625
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz      33478 s         10 s       1841 s      26092 s          0 s
       #2  2593 MHz      16356 s         12 s       1455 s      43688 s          0 s
       
  Memory: 6.790924072265625 GB (3440.0859375 MB free)
  Uptime: 620.0 sec
  Load Avg:  1.0185546875  0.884765625  0.49560546875
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake)
```
...
## Job Properties
* Time of benchmark: 6 Jul 2021 - 1:4
* Package commit: cd02d0
* Julia commit: 44fa15
...
| `["collectors", ":comp => \"filter\"", ":impl => \"vec\""]`                              |  38.201 μs (5%) |           | 128.59 KiB (1%) |          13 |
...
| `["dataframes", "Categorical"]`                                                          | 544.588 ms (5%) | 78.559 ms | 889.14 MiB (1%) |     4925452 |
| `["dataframes", "Int-Int"]`                                                              |   1.119 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                          |   1.552 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-String"]`                                                       |   1.558 ms (5%) |           | 160.27 KiB (1%) |       10252 |
...
| `["mergewith", ":combine => :+", ":desttype => :widen", ":destkeys => :empty"]`          |  38.100 μs (5%) |           |  92.31 KiB (1%) |          18 |
...
## Job Properties
* Time of benchmark: 6 Jul 2021 - 1:6
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                    | 504.508 μs (5%) |           |                 |             |
...
| `["dataframes", "Categorical"]`                                                          | 628.200 ms (5%) | 95.938 ms | 909.14 MiB (1%) |     5335052 |
