...
* Pull request commit: [`3cc0eacb64b7ae84e8fbc953d312640dea352143`](https://github.com/JuliaFolds/BangBang.jl/commit/3cc0eacb64b7ae84e8fbc953d312640dea352143)
...
## Job Properties
* Time of benchmarks:
    - Target: 28 Jul 2021 - 01:05
    - Baseline: 28 Jul 2021 - 01:07
* Package commits:
    - Target: acd589
    - Baseline: a10491
* Julia commits:
...
| `["collectors", ":comp => \"map\"", ":impl => \"coll\""]`                                |                1.32 (5%) :x: |                   1.00 (1%)  |
| `["collectors", ":comp => \"map\"", ":impl => \"man\""]`                                 | 0.89 (5%) :white_check_mark: |                   1.00 (1%)  |
| `["dataframes", "Categorical"]`                                                          | 0.94 (5%) :white_check_mark: | 0.98 (1%) :white_check_mark: |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz       8834 s         16 s       1377 s      34507 s          0 s
       #2  2593 MHz      27852 s          6 s       1571 s      15382 s          0 s
       
  Memory: 6.790924072265625 GB (3283.515625 MB free)
  Uptime: 453.0 sec
  Load Avg:  1.0  0.806640625  0.40966796875
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz      19284 s         16 s       1751 s      37543 s          0 s
       #2  2593 MHz      30954 s          6 s       1780 s      25911 s          0 s
       
  Memory: 6.790924072265625 GB (3320.30078125 MB free)
  Uptime: 591.0 sec
  Load Avg:  1.0087890625  0.89599609375  0.5029296875
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake)
```
...
## Job Properties
* Time of benchmark: 28 Jul 2021 - 1:5
* Package commit: acd589
* Julia commit: 44fa15
...
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  72.301 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 566.705 ms (5%) | 77.966 ms | 889.14 MiB (1%) |     4925452 |
...
| `["dataframes", "String-String"]`                                                        |   1.537 ms (5%) |           | 160.27 KiB (1%) |       10252 |
...
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :half"]`      |  36.101 μs (5%) |           |  68.34 KiB (1%) |           5 |
| `["mergewith", ":combine => :+", ":desttype => :widen", ":destkeys => :empty"]`          |  38.501 μs (5%) |           |  92.31 KiB (1%) |          18 |
...
## Job Properties
* Time of benchmark: 28 Jul 2021 - 1:7
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                    | 524.110 μs (5%) |           |                 |             |
...
| `["collectors", ":comp => \"filter\"", ":impl => \"nonexpanding\""]`                     |  42.801 μs (5%) |           | 312.75 KiB (1%) |        5005 |
| `["collectors", ":comp => \"filter\"", ":impl => \"vec\""]`                              |  38.401 μs (5%) |           | 128.59 KiB (1%) |          13 |
...
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  71.902 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 602.854 ms (5%) | 69.870 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                              |   1.151 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                          |   1.656 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-String"]`                                                       |   1.515 ms (5%) |           | 160.27 KiB (1%) |       10252 |
...
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :half"]`      |  40.101 μs (5%) |           |  68.34 KiB (1%) |           5 |
