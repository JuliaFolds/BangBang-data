...
* Pull request commit: [`82b2e35e465002ee56a1a55d3ac06798efdfc10b`](https://github.com/JuliaFolds/BangBang.jl/commit/82b2e35e465002ee56a1a55d3ac06798efdfc10b)
...
## Job Properties
* Time of benchmarks:
    - Target: 29 Jul 2021 - 01:00
    - Baseline: 29 Jul 2021 - 01:03
* Package commits:
    - Target: 7bdc99
    - Baseline: a10491
* Julia commits:
...
| `["collectors", ":comp => \"filter\"", ":impl => \"coll\""]`                             | 0.95 (5%) :white_check_mark: |                   1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz       8308 s         10 s       1363 s      29019 s          0 s
       #2  2593 MHz      26414 s          8 s       1492 s      11054 s          0 s
       
  Memory: 6.790924072265625 GB (3331.50390625 MB free)
  Uptime: 394.0 sec
  Load Avg:  1.046875  0.85302734375  0.431640625
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz      10764 s         10 s       1633 s      39407 s          0 s
       #2  2593 MHz      36773 s          8 s       1786 s      13550 s          0 s
       
  Memory: 6.790924072265625 GB (3286.625 MB free)
  Uptime: 525.0 sec
  Load Avg:  1.0029296875  0.91015625  0.51123046875
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake)
```
...
## Job Properties
* Time of benchmark: 29 Jul 2021 - 1:0
* Package commit: 7bdc99
* Julia commit: 44fa15
...
| `["collectors", ":comp => \"filter\"", ":impl => \"coll\""]`                             |  42.500 μs (5%) |           | 284.81 KiB (1%) |        5012 |
...
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  66.300 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 512.905 ms (5%) | 87.796 ms | 889.14 MiB (1%) |     4925452 |
| `["dataframes", "Int-Int"]`                                                              |   1.019 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                          |   1.363 ms (5%) |           | 160.23 KiB (1%) |       10251 |
...
## Job Properties
* Time of benchmark: 29 Jul 2021 - 1:3
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                    | 412.808 μs (5%) |           |                 |             |
| `["append", "append!!(Empty(SVector), ::SingletonVector)"]`                              |  10.310 ns (5%) |           |                 |             |
...
| `["collectors", ":comp => \"filter\"", ":impl => \"nonexpanding\""]`                     |  39.700 μs (5%) |           | 312.75 KiB (1%) |        5005 |
| `["collectors", ":comp => \"filter\"", ":impl => \"vec\""]`                              |  36.701 μs (5%) |           | 128.59 KiB (1%) |          13 |
...
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  67.301 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 564.502 ms (5%) | 86.224 ms | 909.14 MiB (1%) |     5335052 |
...
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :empty"]`     |  38.801 μs (5%) |           |  91.72 KiB (1%) |          14 |
...
| `["mergewith", ":combine => :right", ":desttype => :compatible", ":destkeys => :half"]`  |  29.001 μs (5%) |           |  68.34 KiB (1%) |           5 |
