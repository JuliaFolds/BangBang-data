...
* Pull request commit: [`f09012c85719c79ea84d2aa0d21b1d1ece97e6fe`](https://github.com/JuliaFolds/BangBang.jl/commit/f09012c85719c79ea84d2aa0d21b1d1ece97e6fe)
...
## Job Properties
* Time of benchmarks:
    - Target: 19 Jan 2021 - 01:34
    - Baseline: 19 Jan 2021 - 01:36
* Package commits:
    - Target: 717c91
    - Baseline: 2070c5
* Julia commits:
...
| `["collectors", ":comp => \"filter\"", ":impl => \"vec\""]`                              |                1.21 (5%) :x: |   1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8171M CPU @ 2.60GHz: 
       ...
       #1  2095 MHz      31287 s          0 s       1672 s      27895 s          0 s
       #2  2095 MHz       7802 s          0 s       1826 s      51481 s          0 s
       
  Memory: 6.791393280029297 GB (3438.91015625 MB free)
  Uptime: 625.0 sec
  Load Avg:  1.0107421875  0.8662109375  0.486328125
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8171M CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2095 MHz      35622 s          0 s       1971 s      37677 s          0 s
       #2  2095 MHz      17628 s          0 s       2123 s      55794 s          0 s
       
  Memory: 6.791393280029297 GB (3441.0234375 MB free)
  Uptime: 770.0 sec
  Load Avg:  1.05126953125  0.9482421875  0.5771484375
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake)
```
...
## Job Properties
* Time of benchmark: 19 Jan 2021 - 1:34
* Package commit: 717c91
* Julia commit: 44fa15
...
|------------------------------------------------------------------------------------------|----------------:|----------:|----------------:|------------:|
| `["append", "append!!(::SVector, ::SingletonVector)"]`                                   |  13.213 ns (5%) |           |                 |             |
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                    | 486.404 μs (5%) |           |                 |             |
| `["append", "append!!(Empty(SVector), ::SingletonVector)"]`                              |  15.215 ns (5%) |           |                 |             |
...
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  65.400 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 605.394 ms (5%) | 72.531 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                              | 923.709 μs (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                          |   1.527 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-String"]`                                                       |   1.513 ms (5%) |           | 160.27 KiB (1%) |       10252 |
| `["dataframes", "String-String"]`                                                        |   1.267 ms (5%) |           | 160.27 KiB (1%) |       10252 |
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :empty"]`     |  40.101 μs (5%) |           |  91.72 KiB (1%) |          14 |
...
| `["mergewith", ":combine => :+", ":desttype => :widen", ":destkeys => :empty"]`          |  41.000 μs (5%) |           |  92.31 KiB (1%) |          18 |
...
| `["mergewith", ":combine => :right", ":desttype => :widen", ":destkeys => :empty"]`      |  37.301 μs (5%) |           |  92.31 KiB (1%) |          18 |
...
## Job Properties
* Time of benchmark: 19 Jan 2021 - 1:36
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                    | 419.004 μs (5%) |           |                 |             |
| `["append", "append!!(Empty(SVector), ::SingletonVector)"]`                              |  11.011 ns (5%) |           |                 |             |
| `["collectors", ":comp => \"filter\"", ":impl => \"base\""]`                             |  34.501 μs (5%) |           | 128.66 KiB (1%) |          14 |
| `["collectors", ":comp => \"filter\"", ":impl => \"coll\""]`                             |  41.700 μs (5%) |           | 284.81 KiB (1%) |        5012 |
| `["collectors", ":comp => \"filter\"", ":impl => \"nonexpanding\""]`                     |  36.400 μs (5%) |           | 312.75 KiB (1%) |        5005 |
| `["collectors", ":comp => \"filter\"", ":impl => \"vec\""]`                              |  31.200 μs (5%) |           | 128.59 KiB (1%) |          13 |
...
| `["dataframes", "Categorical"]`                                                          | 627.548 ms (5%) | 62.568 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                              |   1.137 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                          |   1.642 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-String"]`                                                       |   1.535 ms (5%) |           | 160.27 KiB (1%) |       10252 |
...
| `["mergewith", ":combine => :right", ":desttype => :compatible", ":destkeys => :empty"]` |  33.201 μs (5%) |           |  91.72 KiB (1%) |          14 |
