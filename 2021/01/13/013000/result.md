...
* Pull request commit: [`8da02e569eaac7757534ad7f1695fcce81bb3048`](https://github.com/JuliaFolds/BangBang.jl/commit/8da02e569eaac7757534ad7f1695fcce81bb3048)
...
## Job Properties
* Time of benchmarks:
    - Target: 13 Jan 2021 - 01:27
    - Baseline: 13 Jan 2021 - 01:29
* Package commits:
    - Target: 203088
    - Baseline: 2070c5
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8171M CPU @ 2.60GHz: 
       ...
       #1  2095 MHz       7690 s          0 s       1529 s      34000 s          0 s
       #2  2095 MHz      30908 s          0 s       1761 s      10901 s          0 s
       
  Memory: 6.7913970947265625 GB (3540.53125 MB free)
  Uptime: 450.0 sec
  Load Avg:  1.0166015625  0.88818359375  0.47216796875
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8171M CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2095 MHz      13486 s          0 s       1834 s      42230 s          0 s
       #2  2095 MHz      39238 s          0 s       2062 s      16620 s          0 s
       
  Memory: 6.7913970947265625 GB (3540.59375 MB free)
  Uptime: 593.0 sec
  Load Avg:  1.009765625  0.947265625  0.56005859375
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake)
```
...
## Job Properties
* Time of benchmark: 13 Jan 2021 - 1:27
* Package commit: 203088
* Julia commit: 44fa15
...
| `["collectors", ":comp => \"filter\"", ":impl => \"nonexpanding\""]`                     |  34.701 μs (5%) |           | 312.75 KiB (1%) |        5005 |
| `["collectors", ":comp => \"filter\"", ":impl => \"vec\""]`                              |  32.500 μs (5%) |           | 128.59 KiB (1%) |          13 |
| `["collectors", ":comp => \"map\"", ":impl => \"coll\""]`                                |   5.875 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"man\""]`                                 |   6.200 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"safe_coll\""]`                           |   9.100 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  58.200 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 556.606 ms (5%) | 68.446 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                              | 930.111 μs (5%) |           | 160.23 KiB (1%) |       10251 |
...
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :empty"]`     |  31.300 μs (5%) |           |  91.72 KiB (1%) |          14 |
...
## Job Properties
* Time of benchmark: 13 Jan 2021 - 1:29
...
| ID                                                                                       | time            | GC time   | memory          | allocations |
|------------------------------------------------------------------------------------------|----------------:|----------:|----------------:|------------:|
| `["append", "append!!(::SVector, ::SingletonVector)"]`                                   |  13.900 ns (5%) |           |                 |             |
...
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  59.002 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 606.721 ms (5%) | 69.921 ms | 909.14 MiB (1%) |     5335052 |
...
| `["mergewith", ":combine => :right", ":desttype => :compatible", ":destkeys => :empty"]` |  29.701 μs (5%) |           |  91.72 KiB (1%) |          14 |
...
| `["mergewith", ":combine => :right", ":desttype => :widen", ":destkeys => :empty"]`      |  34.401 μs (5%) |           |  92.31 KiB (1%) |          18 |
