...
* Pull request commit: [`9bcc21a4d02ad95d5ef48e73fa1f8a6232ec0d05`](https://github.com/JuliaFolds/BangBang.jl/commit/9bcc21a4d02ad95d5ef48e73fa1f8a6232ec0d05)
...
## Job Properties
* Time of benchmarks:
    - Target: 30 Jan 2021 - 17:22
    - Baseline: 30 Jan 2021 - 17:24
* Package commits:
    - Target: f6d368
    - Baseline: 7bb53b
* Julia commits:
...
| `["collectors", ":comp => \"map\"", ":impl => \"man\""]`                                 |                1.50 (5%) :x: |   1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz      19670 s          0 s       1532 s      17739 s          0 s
       #2  2593 MHz      14532 s          0 s       1379 s      23569 s          0 s
       
  Memory: 6.791393280029297 GB (3603.66015625 MB free)
  Uptime: 408.0 sec
  Load Avg:  1.013671875  0.82666015625  0.4169921875
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz      21431 s          0 s       1578 s      26419 s          0 s
       #2  2593 MHz      23210 s          0 s       1497 s      25283 s          0 s
       
  Memory: 6.791393280029297 GB (3586.8046875 MB free)
  Uptime: 513.0 sec
  Load Avg:  1.0166015625  0.89404296875  0.48876953125
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake)
```
...
## Job Properties
* Time of benchmark: 30 Jan 2021 - 17:22
* Package commit: f6d368
* Julia commit: 44fa15
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                    | 508.708 μs (5%) |           |                 |             |
...
| `["dataframes", "Categorical"]`                                                          | 557.171 ms (5%) | 73.147 ms | 909.14 MiB (1%) |     5335052 |
...
## Job Properties
* Time of benchmark: 30 Jan 2021 - 17:24
* Package commit: 7bb53b
* Julia commit: 44fa15
* Julia command flags: None
* Environment variables: None
...
| `["dataframes", "Categorical"]`                                                          | 583.319 ms (5%) | 76.296 ms | 909.14 MiB (1%) |     5335052 |
...
| `["dataframes", "String-String"]`                                                        |   1.546 ms (5%) |           | 160.27 KiB (1%) |       10252 |
