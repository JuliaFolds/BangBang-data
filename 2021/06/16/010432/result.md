...
* Pull request commit: [`1df9577647cd3ad7241d39d07fc285cf60b04472`](https://github.com/JuliaFolds/BangBang.jl/commit/1df9577647cd3ad7241d39d07fc285cf60b04472)
...
## Job Properties
* Time of benchmarks:
    - Target: 16 Jun 2021 - 01:01
    - Baseline: 16 Jun 2021 - 01:03
* Package commits:
    - Target: 898317
    - Baseline: a10491
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz       6757 s         12 s       1234 s      34209 s          0 s
       #2  2593 MHz      28859 s          6 s       1505 s      12131 s          0 s
       
  Memory: 6.790924072265625 GB (3491.60546875 MB free)
  Uptime: 427.0 sec
  Load Avg:  1.0  0.78564453125  0.392578125
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz      16713 s         12 s       1528 s      37677 s          0 s
       #2  2593 MHz      32340 s          6 s       1802 s      22044 s          0 s
       
  Memory: 6.790924072265625 GB (3503.9296875 MB free)
  Uptime: 565.0 sec
  Load Avg:  1.009765625  0.88037109375  0.4853515625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake)
```
...
## Job Properties
* Time of benchmark: 16 Jun 2021 - 1:1
* Package commit: 898317
* Julia commit: 44fa15
...
| `["collectors", ":comp => \"filter\"", ":impl => \"coll\""]`                             |  45.801 μs (5%) |           | 284.81 KiB (1%) |        5012 |
...
| `["collectors", ":comp => \"map\"", ":impl => \"man\""]`                                 |   5.866 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"safe_coll\""]`                           |  11.000 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  69.100 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 533.157 ms (5%) | 79.720 ms | 889.14 MiB (1%) |     4925452 |
...
## Job Properties
* Time of benchmark: 16 Jun 2021 - 1:3
...
| ID                                                                                       | time            | GC time   | memory          | allocations |
|------------------------------------------------------------------------------------------|----------------:|----------:|----------------:|------------:|
| `["append", "append!!(::SVector, ::SingletonVector)"]`                                   |  11.711 ns (5%) |           |                 |             |
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                    | 502.599 μs (5%) |           |                 |             |
| `["append", "append!!(Empty(SVector), ::SingletonVector)"]`                              |  11.711 ns (5%) |           |                 |             |
| `["collectors", ":comp => \"filter\"", ":impl => \"base\""]`                             |  38.500 μs (5%) |           | 128.66 KiB (1%) |          14 |
| `["collectors", ":comp => \"filter\"", ":impl => \"coll\""]`                             |  44.400 μs (5%) |           | 284.81 KiB (1%) |        5012 |
| `["collectors", ":comp => \"filter\"", ":impl => \"nonexpanding\""]`                     |  43.200 μs (5%) |           | 312.75 KiB (1%) |        5005 |
...
| `["dataframes", "Categorical"]`                                                          | 590.364 ms (5%) | 73.511 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                              |   1.174 ms (5%) |           | 160.23 KiB (1%) |       10251 |
...
| `["mergewith", ":combine => :right", ":desttype => :widen", ":destkeys => :empty"]`      |  38.300 μs (5%) |           |  92.31 KiB (1%) |          18 |
