...
* Pull request commit: [`f54df970e536626eee18e40039305e346606246c`](https://github.com/JuliaFolds/BangBang.jl/commit/f54df970e536626eee18e40039305e346606246c)
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz       7994 s         12 s       1262 s      54999 s          0 s
       #2  2593 MHz      25976 s          5 s       1326 s      36998 s          0 s
       
  Memory: 6.790924072265625 GB (3488.76171875 MB free)
  Uptime: 647.0 sec
  Load Avg:  1.15234375  0.81005859375  0.39501953125
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz      15939 s         12 s       1362 s      56759 s          0 s
       #2  2593 MHz      27842 s          5 s       1378 s      44841 s          0 s
       
  Memory: 6.790924072265625 GB (3273.68359375 MB free)
  Uptime: 745.0 sec
  Load Avg:  1.10888671875  0.89404296875  0.46875
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake)
```
...
## Job Properties
* Time of benchmark: 14 Jun 2021 - 1:18
* Package commit: 42d0c8
* Julia commit: 44fa15
...
| `["collectors", ":comp => \"map\"", ":impl => \"coll\""]`                                |   5.280 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"man\""]`                                 |   4.163 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"safe_coll\""]`                           |  10.000 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  62.501 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 510.929 ms (5%) | 55.810 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                              |   1.123 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                          |   1.541 ms (5%) |           | 160.23 KiB (1%) |       10251 |
...
| `["dataframes", "Categorical"]`                                                          | 520.435 ms (5%) | 51.050 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                              |   1.122 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                          |   1.541 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-String"]`                                                       |   1.555 ms (5%) |           | 160.27 KiB (1%) |       10252 |
| `["dataframes", "String-String"]`                                                        |   1.560 ms (5%) |           | 160.27 KiB (1%) |       10252 |
