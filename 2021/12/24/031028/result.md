...
* Pull request commit: [`631ac03c0d4de68bc2cbdd1769a558de6f839242`](https://github.com/JuliaFolds/BangBang.jl/commit/631ac03c0d4de68bc2cbdd1769a558de6f839242)
...
## Job Properties
* Time of benchmarks:
    - Target: 24 Dec 2021 - 03:08
    - Baseline: 24 Dec 2021 - 03:09
* Package commits:
    - Target: c39e2e
    - Baseline: 6e7260
* Julia commits:
...
| `["dataframes", "Categorical"]`                                                          |                1.06 (5%) :x: |   1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz       5935 s         11 s       1279 s      36255 s          0 s
       #2  2593 MHz      30312 s         10 s       1777 s      12004 s          0 s
       
  Memory: 6.788978576660156 GB (3087.48046875 MB free)
  Uptime: 444.0 sec
  Load Avg:  1.07958984375  0.82080078125  0.4130859375
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz       6079 s         11 s       1325 s      46757 s          0 s
       #2  2593 MHz      40867 s         10 s       1870 s      12080 s          0 s
       
  Memory: 6.788978576660156 GB (3060.2578125 MB free)
  Uptime: 551.0 sec
  Load Avg:  1.009765625  0.88037109375  0.48388671875
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake)
```
...
## Job Properties
* Time of benchmark: 24 Dec 2021 - 3:8
* Package commit: c39e2e
* Julia commit: 44fa15
...
| `["dataframes", "Categorical"]`                                                          | 538.554 ms (5%) | 69.119 ms | 909.14 MiB (1%) |     5335052 |
...
## Job Properties
* Time of benchmark: 24 Dec 2021 - 3:9
...
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  69.102 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 507.194 ms (5%) | 64.169 ms | 909.14 MiB (1%) |     5335052 |
...
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :half"]`      |  32.800 μs (5%) |           |  68.34 KiB (1%) |           5 |
