...
* Pull request commit: [`f99e2489993678afe5b48078cbab2296224cecd2`](https://github.com/JuliaFolds/BangBang.jl/commit/f99e2489993678afe5b48078cbab2296224cecd2)
...
## Job Properties
* Time of benchmarks:
    - Target: 30 Mar 2021 - 01:06
    - Baseline: 30 Mar 2021 - 01:08
* Package commits:
    - Target: 14ae0d
    - Baseline: eecbf8
* Julia commits:
...
| `["collectors", ":comp => \"filter\"", ":impl => \"base\""]`                             | 0.94 (5%) :white_check_mark: |   1.00 (1%)  |
...
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :half"]`      |                1.60 (5%) :x: | Inf (1%) :x: |
...
| `["mergewith", ":combine => :right", ":desttype => :compatible", ":destkeys => :half"]`  |                1.38 (5%) :x: | Inf (1%) :x: |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz: 
       ...
       #1  2294 MHz       9788 s         10 s       1337 s      32833 s          0 s
       #2  2294 MHz      29770 s          6 s       1909 s      12857 s          0 s
       
  Memory: 6.791343688964844 GB (3296.15234375 MB free)
  Uptime: 455.0 sec
  Load Avg:  1.0  0.86865234375  0.46728515625
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz: 
              speed         user         nice          sys         idle          irq
       #1  2294 MHz      19659 s         10 s       1648 s      36368 s          0 s
       #2  2294 MHz      33297 s          6 s       2196 s      22757 s          0 s
       
  Memory: 6.791343688964844 GB (3322.4765625 MB free)
  Uptime: 593.0 sec
  Load Avg:  1.00732421875  0.9248046875  0.54833984375
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, broadwell)
```
...
## Job Properties
* Time of benchmark: 30 Mar 2021 - 1:6
* Package commit: 14ae0d
* Julia commit: 44fa15
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                    | 411.600 μs (5%) |           |                 |             |
| `["append", "append!!(Empty(SVector), ::SingletonVector)"]`                              |   9.699 ns (5%) |           |                 |             |
...
| `["collectors", ":comp => \"map\"", ":impl => \"coll\""]`                                |   5.540 μs (5%) |           |  78.20 KiB (1%) |           2 |
...
| `["dataframes", "Categorical"]`                                                          | 534.900 ms (5%) | 74.866 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                              | 914.999 μs (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                          |   1.286 ms (5%) |           | 160.23 KiB (1%) |       10251 |
...
| `["mergewith", ":combine => :+", ":desttype => :widen", ":destkeys => :empty"]`          |  39.200 μs (5%) |           |  92.31 KiB (1%) |          18 |
...
## Job Properties
* Time of benchmark: 30 Mar 2021 - 1:8
...
| `["dataframes", "Categorical"]`                                                          | 612.943 ms (5%) | 70.871 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                              | 938.200 μs (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                          |   1.292 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-String"]`                                                       |   1.323 ms (5%) |           | 160.27 KiB (1%) |       10252 |
| `["dataframes", "String-String"]`                                                        |   1.265 ms (5%) |           | 160.27 KiB (1%) |       10252 |
...
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :half"]`      |  20.500 μs (5%) |           |                 |             |
| `["mergewith", ":combine => :+", ":desttype => :widen", ":destkeys => :empty"]`          |  31.900 μs (5%) |           |  92.31 KiB (1%) |          18 |
| `["mergewith", ":combine => :right", ":desttype => :compatible", ":destkeys => :empty"]` |  33.100 μs (5%) |           |  91.72 KiB (1%) |          14 |
| `["mergewith", ":combine => :right", ":desttype => :compatible", ":destkeys => :equal"]` |  17.501 μs (5%) |           |                 |             |
| `["mergewith", ":combine => :right", ":desttype => :compatible", ":destkeys => :half"]`  |  20.900 μs (5%) |           |                 |             |
