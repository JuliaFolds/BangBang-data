...
* Pull request commit: [`fd6a16d0c2bd9e6e926826fd84c5325d7df50014`](https://github.com/JuliaFolds/BangBang.jl/commit/fd6a16d0c2bd9e6e926826fd84c5325d7df50014)
...
## Job Properties
* Time of benchmarks:
    - Target: 27 Apr 2021 - 01:09
    - Baseline: 27 Apr 2021 - 01:12
* Package commits:
    - Target: d4ac59
    - Baseline: eecbf8
* Julia commits:
...
| `["collectors", ":comp => \"map\"", ":impl => \"coll\""]`                                | 0.64 (5%) :white_check_mark: |                   1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz: 
       ...
       #1  2294 MHz      12612 s         19 s       1589 s      36599 s          0 s
       #2  2294 MHz      27767 s          8 s       1853 s      21247 s          0 s
       
  Memory: 6.791343688964844 GB (3448.9453125 MB free)
  Uptime: 514.0 sec
  Load Avg:  1.025390625  0.88330078125  0.46630859375
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz: 
              speed         user         nice          sys         idle          irq
       #1  2294 MHz      23024 s         19 s       1860 s      41971 s          0 s
       #2  2294 MHz      33051 s          8 s       2302 s      31557 s          0 s
       
  Memory: 6.791343688964844 GB (3438.6875 MB free)
  Uptime: 675.0 sec
  Load Avg:  1.02197265625  0.9501953125  0.5625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, broadwell)
```
...
## Job Properties
* Time of benchmark: 27 Apr 2021 - 1:9
* Package commit: d4ac59
* Julia commit: 44fa15
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                    | 407.695 μs (5%) |           |                 |             |
| `["append", "append!!(Empty(SVector), ::SingletonVector)"]`                              |  10.599 ns (5%) |           |                 |             |
...
| `["collectors", ":comp => \"map\"", ":impl => \"man\""]`                                 |   4.875 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"safe_coll\""]`                           |   9.200 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  68.801 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 636.889 ms (5%) | 89.582 ms | 889.14 MiB (1%) |     4925452 |
| `["dataframes", "Int-Int"]`                                                              | 934.707 μs (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                          |   1.334 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-String"]`                                                       |   1.357 ms (5%) |           | 160.27 KiB (1%) |       10252 |
| `["dataframes", "String-String"]`                                                        |   1.272 ms (5%) |           | 160.27 KiB (1%) |       10252 |
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :empty"]`     |  43.300 μs (5%) |           |  91.72 KiB (1%) |          14 |
...
| `["mergewith", ":combine => :right", ":desttype => :widen", ":destkeys => :empty"]`      |  38.201 μs (5%) |           |  92.31 KiB (1%) |          18 |
...
## Job Properties
* Time of benchmark: 27 Apr 2021 - 1:12
...
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  71.400 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 682.630 ms (5%) | 91.784 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                              | 928.707 μs (5%) |           | 160.23 KiB (1%) |       10251 |
...
| `["mergewith", ":combine => :+", ":desttype => :compatible", ":destkeys => :empty"]`     |  40.500 μs (5%) |           |  91.72 KiB (1%) |          14 |
...
| `["mergewith", ":combine => :right", ":desttype => :widen", ":destkeys => :empty"]`      |  44.800 μs (5%) |           |  92.31 KiB (1%) |          18 |
