...
* Pull request commit: [`f2ac3fbee69ad217adcc602d6a5592c124910aab`](https://github.com/JuliaFolds/BangBang.jl/commit/f2ac3fbee69ad217adcc602d6a5592c124910aab)
...
## Job Properties
* Time of benchmarks:
    - Target: 21 Apr 2021 - 01:09
    - Baseline: 21 Apr 2021 - 01:12
* Package commits:
    - Target: 057b36
    - Baseline: eecbf8
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz: 
       ...
       #1  2294 MHz      10048 s          9 s       1706 s      59546 s          0 s
       #2  2294 MHz      33207 s         12 s       1767 s      36660 s          0 s
       
  Memory: 6.791343688964844 GB (3405.4453125 MB free)
  Uptime: 721.0 sec
  Load Avg:  1.0322265625  0.8095703125  0.40673828125
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz: 
              speed         user         nice          sys         idle          irq
       #1  2294 MHz      13322 s          9 s       1946 s      71305 s          0 s
       #2  2294 MHz      44987 s         12 s       2152 s      39785 s          0 s
       
  Memory: 6.791343688964844 GB (3402.4296875 MB free)
  Uptime: 874.0 sec
  Load Avg:  1.11865234375  0.9365234375  0.5205078125
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, broadwell)
```
...
## Job Properties
* Time of benchmark: 21 Apr 2021 - 1:9
* Package commit: 057b36
* Julia commit: 44fa15
...
| `["collectors", ":comp => \"map\"", ":impl => \"coll\""]`                                |   6.250 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"man\""]`                                 |   6.350 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"safe_coll\""]`                           |   9.000 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  62.900 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 670.454 ms (5%) | 97.528 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                              | 995.406 μs (5%) |           | 160.23 KiB (1%) |       10251 |
...
| `["mergewith", ":combine => :+", ":desttype => :widen", ":destkeys => :empty"]`          |  41.901 μs (5%) |           |  92.31 KiB (1%) |          18 |
...
| `["mergewith", ":combine => :right", ":desttype => :compatible", ":destkeys => :half"]`  |  27.800 μs (5%) |           |  68.34 KiB (1%) |           5 |
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                    | 408.302 μs (5%) |           |                 |             |
| `["append", "append!!(Empty(SVector), ::SingletonVector)"]`                              |   9.700 ns (5%) |           |                 |             |
...
| `["dataframes", "Categorical"]`                                                          | 706.687 ms (5%) | 82.081 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                              | 999.905 μs (5%) |           | 160.23 KiB (1%) |       10251 |
