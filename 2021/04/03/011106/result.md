...
* Pull request commit: [`019979a9bafe1e9f064b6e0158beaf74e535e4e1`](https://github.com/JuliaFolds/BangBang.jl/commit/019979a9bafe1e9f064b6e0158beaf74e535e4e1)
...
## Job Properties
* Time of benchmarks:
    - Target: 3 Apr 2021 - 01:08
    - Baseline: 3 Apr 2021 - 01:10
* Package commits:
    - Target: 6e45fc
    - Baseline: eecbf8
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz: 
       ...
       #1  2294 MHz       9599 s         11 s       1296 s      33128 s          0 s
       #2  2294 MHz      30750 s         10 s       1828 s      11815 s          0 s
       
  Memory: 6.791343688964844 GB (3430.66015625 MB free)
  Uptime: 453.0 sec
  Load Avg:  1.0322265625  0.85009765625  0.4404296875
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz: 
              speed         user         nice          sys         idle          irq
       #1  2294 MHz      20260 s         11 s       1709 s      36445 s          0 s
       #2  2294 MHz      34141 s         10 s       2072 s      22564 s          0 s
       
  Memory: 6.791343688964844 GB (3480.94140625 MB free)
  Uptime: 598.0 sec
  Load Avg:  1.01171875  0.923828125  0.533203125
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, broadwell)
```
...
## Job Properties
* Time of benchmark: 3 Apr 2021 - 1:8
* Package commit: 6e45fc
* Julia commit: 44fa15
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                    | 416.300 μs (5%) |           |                 |             |
...
| `["dataframes", "Categorical"]`                                                          | 604.344 ms (5%) | 90.411 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                              | 936.801 μs (5%) |           | 160.23 KiB (1%) |       10251 |
...
## Job Properties
* Time of benchmark: 3 Apr 2021 - 1:10
...
| `["collectors", ":comp => \"map\"", ":impl => \"safe_coll\""]`                           |   8.800 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", ":comp => \"map\"", ":impl => \"vec\""]`                                 |  57.900 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                          | 643.544 ms (5%) | 73.978 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                              | 912.301 μs (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                          |   1.260 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-String"]`                                                       |   1.313 ms (5%) |           | 160.27 KiB (1%) |       10252 |
