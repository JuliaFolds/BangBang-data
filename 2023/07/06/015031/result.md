...
* Pull request commit: [`3ecb088dc39893fbe0082a9af545b6bd17b9d144`](https://github.com/JuliaFolds/BangBang.jl/commit/3ecb088dc39893fbe0082a9af545b6bd17b9d144)
...
## Job Properties
* Time of benchmarks:
    - Target: 6 Jul 2023 - 01:47
    - Baseline: 6 Jul 2023 - 01:49
* Package commits:
    - Target: 61657d
    - Baseline: d70a19
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
       ...
       #1  2793 MHz      24186 s          0 s       1866 s      23177 s          0 s
       #2  2793 MHz      15491 s          0 s       1990 s      31774 s          0 s
       
  Memory: 6.7694854736328125 GB (3195.22265625 MB free)
  Uptime: 497.0 sec
  Load Avg:  1.11962890625  0.873046875  0.458984375
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
              speed         user         nice          sys         idle          irq
       #1  2793 MHz      34630 s          0 s       2302 s      25301 s          0 s
       #2  2793 MHz      17874 s          0 s       2227 s      42129 s          0 s
       
  Memory: 6.7694854736328125 GB (3273.30078125 MB free)
  Uptime: 628.0 sec
  Load Avg:  1.1103515625  0.9970703125  0.56396484375
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake-avx512)
```
...
## Job Properties
* Time of benchmark: 6 Jul 2023 - 1:47
* Package commit: 61657d
* Julia commit: 44fa15
...
| `["collectors", :(:comp => "map"), :(:impl => "vec")]`                                      |  65.199 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                             | 453.512 ms (5%) | 53.758 ms | 804.14 MiB (1%) |     4024332 |
...
| `["mergewith", :(:combine => :+), :(:desttype => :compatible), :(:destkeys => :empty)]`     |  24.799 μs (5%) |           |  91.72 KiB (1%) |          14 |
...
| `["mergewith", :(:combine => :right), :(:desttype => :compatible), :(:destkeys => :empty)]` |  24.500 μs (5%) |           |  91.72 KiB (1%) |          14 |
...
| `["mergewith", :(:combine => :right), :(:desttype => :widen), :(:destkeys => :empty)]`      |  24.300 μs (5%) |           |  92.31 KiB (1%) |          18 |
...
## Job Properties
* Time of benchmark: 6 Jul 2023 - 1:49
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                       | 487.597 μs (5%) |           |                 |             |
...
| `["collectors", :(:comp => "filter"), :(:impl => "nonexpanding")]`                          |  34.899 μs (5%) |           | 312.75 KiB (1%) |        5005 |
...
| `["dataframes", "Categorical"]`                                                             | 579.906 ms (5%) | 64.450 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                                 |   1.116 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                             |   1.421 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-String"]`                                                          |   1.425 ms (5%) |           | 160.27 KiB (1%) |       10252 |
| `["dataframes", "String-String"]`                                                           |   1.381 ms (5%) |           | 160.27 KiB (1%) |       10252 |
