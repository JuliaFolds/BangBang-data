...
* Pull request commit: [`b34401dd7e310ceae9ce300a451b851ddd0746a3`](https://github.com/JuliaFolds/BangBang.jl/commit/b34401dd7e310ceae9ce300a451b851ddd0746a3)
...
## Job Properties
* Time of benchmarks:
    - Target: 6 May 2023 - 01:14
    - Baseline: 6 May 2023 - 01:16
* Package commits:
    - Target: a2d513
    - Baseline: d70a19
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz      32597 s          1 s       2067 s      25657 s          0 s
       #2  2593 MHz       7792 s          1 s       1720 s      50390 s          0 s
       
  Memory: 6.781208038330078 GB (3261.0390625 MB free)
  Uptime: 608.0 sec
  Load Avg:  1.0390625  0.96826171875  0.55078125
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz      43476 s          1 s       2519 s      27571 s          0 s
       #2  2593 MHz      10059 s          1 s       1953 s      61105 s          0 s
       
  Memory: 6.781208038330078 GB (3301.2421875 MB free)
  Uptime: 741.0 sec
  Load Avg:  1.28662109375  1.0859375  0.6572265625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake)
```
...
| `["dataframes", "Categorical"]`                                                             | 444.931 ms (5%) | 52.360 ms | 804.14 MiB (1%) |     4024332 |
...
## Job Properties
* Time of benchmark: 6 May 2023 - 1:16
...
|---------------------------------------------------------------------------------------------|----------------:|----------:|----------------:|------------:|
| `["append", "append!!(::SVector, ::SingletonVector)"]`                                      |  11.311 ns (5%) |           |                 |             |
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                       | 508.504 μs (5%) |           |                 |             |
| `["append", "append!!(Empty(SVector), ::SingletonVector)"]`                                 |  11.311 ns (5%) |           |                 |             |
...
| `["collectors", :(:comp => "filter"), :(:impl => "nonexpanding")]`                          |  41.101 μs (5%) |           | 312.75 KiB (1%) |        5005 |
| `["collectors", :(:comp => "filter"), :(:impl => "vec")]`                                   |  37.201 μs (5%) |           | 128.59 KiB (1%) |          13 |
...
| `["dataframes", "Categorical"]`                                                             | 614.327 ms (5%) | 79.188 ms | 909.14 MiB (1%) |     5335052 |
