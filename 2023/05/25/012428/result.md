...
* Pull request commit: [`a58a111c7d69a9defab94c961c241a5903905ad7`](https://github.com/JuliaFolds/BangBang.jl/commit/a58a111c7d69a9defab94c961c241a5903905ad7)
...
## Job Properties
* Time of benchmarks:
    - Target: 25 May 2023 - 01:21
    - Baseline: 25 May 2023 - 01:23
* Package commits:
    - Target: ab4865
    - Baseline: d70a19
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz: 
       ...
       #1  2294 MHz      14714 s          0 s       1890 s      40692 s          0 s
       #2  2294 MHz      28365 s          0 s       2346 s      26563 s          0 s
       
  Memory: 6.781208038330078 GB (3191.484375 MB free)
  Uptime: 580.0 sec
  Load Avg:  1.03955078125  0.95556640625  0.525390625
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) CPU E5-2673 v4 @ 2.30GHz: 
              speed         user         nice          sys         idle          irq
       #1  2294 MHz      21038 s          0 s       2319 s      49338 s          0 s
       #2  2294 MHz      37250 s          0 s       2693 s      32733 s          0 s
       
  Memory: 6.781208038330078 GB (3256.19140625 MB free)
  Uptime: 735.0 sec
  Load Avg:  1.0166015625  0.9931640625  0.60986328125
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, broadwell)
```
...
## Job Properties
* Time of benchmark: 25 May 2023 - 1:21
* Package commit: ab4865
* Julia commit: 44fa15
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                       | 415.200 μs (5%) |           |                 |             |
...
| `["dataframes", "Categorical"]`                                                             | 531.055 ms (5%) | 75.879 ms | 804.14 MiB (1%) |     4024332 |
| `["dataframes", "Int-Int"]`                                                                 | 939.699 μs (5%) |           | 160.23 KiB (1%) |       10251 |
...
## Job Properties
* Time of benchmark: 25 May 2023 - 1:23
...
| ID                                                                                          | time            | GC time    | memory          | allocations |
|---------------------------------------------------------------------------------------------|----------------:|-----------:|----------------:|------------:|
| `["append", "append!!(::SVector, ::SingletonVector)"]`                                      |  11.499 ns (5%) |            |                 |             |
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                       | 455.400 μs (5%) |            |                 |             |
...
| `["dataframes", "Categorical"]`                                                             | 775.676 ms (5%) | 108.265 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                                 | 931.200 μs (5%) |            | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                             |   1.354 ms (5%) |            | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-String"]`                                                          |   1.435 ms (5%) |            | 160.27 KiB (1%) |       10252 |
