...
* Pull request commit: [`f5120d402c2f14466c083ed6ad1d1134b25e4c3f`](https://github.com/JuliaFolds/BangBang.jl/commit/f5120d402c2f14466c083ed6ad1d1134b25e4c3f)
...
## Job Properties
* Time of benchmarks:
    - Target: 27 Oct 2023 - 01:08
    - Baseline: 27 Oct 2023 - 01:11
* Package commits:
    - Target: 74c16b
    - Baseline: d70a19
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz       9778 s          1 s       1813 s      46997 s          0 s
       #2  2593 MHz      31215 s          0 s       1920 s      25344 s          0 s
       
  Memory: 6.759746551513672 GB (2968.6171875 MB free)
  Uptime: 592.0 sec
  Load Avg:  1.0419921875  0.888671875  0.47314453125
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz      12457 s          1 s       2270 s      57095 s          0 s
       #2  2593 MHz      41643 s          0 s       2269 s      27834 s          0 s
       
  Memory: 6.759746551513672 GB (3024.08203125 MB free)
  Uptime: 724.0 sec
  Load Avg:  1.060546875  0.947265625  0.55322265625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake)
```
...
## Job Properties
* Time of benchmark: 27 Oct 2023 - 1:8
* Package commit: 74c16b
* Julia commit: 44fa15
...
| `["collectors", :(:comp => "filter"), :(:impl => "coll")]`                                  |  39.201 μs (5%) |           | 284.81 KiB (1%) |        5012 |
...
| `["collectors", :(:comp => "map"), :(:impl => "coll")]`                                     |   6.125 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "man")]`                                      |   5.700 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "safe_coll")]`                                |  10.900 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "vec")]`                                      |  66.400 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                             | 456.387 ms (5%) | 55.894 ms | 804.14 MiB (1%) |     4024332 |
...
## Job Properties
* Time of benchmark: 27 Oct 2023 - 1:11
...
| `["collectors", :(:comp => "map"), :(:impl => "vec")]`                                      |  63.700 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                             | 601.640 ms (5%) | 64.717 ms | 909.14 MiB (1%) |     5335052 |
