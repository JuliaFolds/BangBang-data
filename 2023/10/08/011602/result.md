...
* Pull request commit: [`48097709620e5cfc0bcfb3130443bcd0bda889c2`](https://github.com/JuliaFolds/BangBang.jl/commit/48097709620e5cfc0bcfb3130443bcd0bda889c2)
...
## Job Properties
* Time of benchmarks:
    - Target: 8 Oct 2023 - 01:13
    - Baseline: 8 Oct 2023 - 01:15
* Package commits:
    - Target: 1bf4cf
    - Baseline: d70a19
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
       ...
       #1  2793 MHz      20668 s          2 s       1609 s      19822 s          0 s
       #2  2793 MHz      19796 s          0 s       1776 s      20465 s          0 s
       
  Memory: 6.759757995605469 GB (3113.296875 MB free)
  Uptime: 427.0 sec
  Load Avg:  1.119140625  0.923828125  0.46923828125
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
              speed         user         nice          sys         idle          irq
       #1  2793 MHz      29886 s          2 s       1929 s      23077 s          0 s
       #2  2793 MHz      23519 s          0 s       2187 s      29101 s          0 s
       
  Memory: 6.759757995605469 GB (3131.90234375 MB free)
  Uptime: 555.0 sec
  Load Avg:  1.08642578125  0.970703125  0.5478515625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake-avx512)
```
...
## Job Properties
* Time of benchmark: 8 Oct 2023 - 1:13
* Package commit: 1bf4cf
* Julia commit: 44fa15
...
| `["collectors", :(:comp => "filter"), :(:impl => "base")]`                                  |  33.999 μs (5%) |           | 128.66 KiB (1%) |          14 |
...
| `["collectors", :(:comp => "filter"), :(:impl => "vec")]`                                   |  34.499 μs (5%) |           | 128.59 KiB (1%) |          13 |
| `["collectors", :(:comp => "map"), :(:impl => "coll")]`                                     |   4.550 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "man")]`                                      |   3.850 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "safe_coll")]`                                |  12.299 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "vec")]`                                      |  62.700 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                             | 446.930 ms (5%) | 52.795 ms | 804.14 MiB (1%) |     4024332 |
...
| `["dataframes", "String-String"]`                                                           |   1.340 ms (5%) |           | 160.27 KiB (1%) |       10252 |
...
## Job Properties
* Time of benchmark: 8 Oct 2023 - 1:15
...
| `["collectors", :(:comp => "filter"), :(:impl => "vec")]`                                   |  35.099 μs (5%) |           | 128.59 KiB (1%) |          13 |
...
| `["dataframes", "Categorical"]`                                                             | 592.827 ms (5%) | 67.673 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                                 |   1.100 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                             |   1.383 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-String"]`                                                          |   1.403 ms (5%) |           | 160.27 KiB (1%) |       10252 |
