...
* Pull request commit: [`6e63205823bbc3268bcf8b44d27507f58b7d1b73`](https://github.com/JuliaFolds/BangBang.jl/commit/6e63205823bbc3268bcf8b44d27507f58b7d1b73)
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
       ...
       #1  2793 MHz      28680 s          1 s       1481 s      19899 s          0 s
       #2  2793 MHz      11581 s          0 s       1817 s      36676 s          0 s
       
  Memory: 6.7597503662109375 GB (3147.1796875 MB free)
  Uptime: 507.0 sec
  Load Avg:  1.0048828125  0.8896484375  0.474609375
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
              speed         user         nice          sys         idle          irq
       #1  2793 MHz      38918 s          1 s       1785 s      22384 s          0 s
       #2  2793 MHz      14097 s          0 s       2241 s      46735 s          0 s
       
  Memory: 6.7597503662109375 GB (3139.8828125 MB free)
  Uptime: 637.0 sec
  Load Avg:  1.0390625  0.9697265625  0.5634765625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake-avx512)
```
...
## Job Properties
* Time of benchmark: 21 Oct 2023 - 1:7
* Package commit: 8df786
* Julia commit: 44fa15
...
| `["collectors", :(:comp => "map"), :(:impl => "man")]`                                      |   5.083 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "safe_coll")]`                                |  12.300 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "vec")]`                                      |  63.000 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                             | 451.231 ms (5%) | 54.684 ms | 804.14 MiB (1%) |     4024332 |
...
| `["dataframes", "Categorical"]`                                                             | 580.974 ms (5%) | 66.582 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                                 |   1.075 ms (5%) |           | 160.23 KiB (1%) |       10251 |
