...
* Pull request commit: [`f626579b52a147d6dc1d272bd15185571fb226f2`](https://github.com/JuliaFolds/BangBang.jl/commit/f626579b52a147d6dc1d272bd15185571fb226f2)
...
## Job Properties
* Time of benchmarks:
    - Target: 13 Apr 2023 - 01:16
    - Baseline: 13 Apr 2023 - 01:18
* Package commits:
    - Target: c7aabf
    - Baseline: d70a19
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
       ...
       #1  2793 MHz      23036 s          0 s       2017 s      17580 s          0 s
       #2  2793 MHz      16708 s          2 s       1652 s      24034 s          0 s
       
  Memory: 6.781211853027344 GB (3269.31640625 MB free)
  Uptime: 430.0 sec
  Load Avg:  1.00244140625  0.85546875  0.44580078125
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
              speed         user         nice          sys         idle          irq
       #1  2793 MHz      26386 s          0 s       2226 s      26833 s          0 s
       #2  2793 MHz      25943 s          2 s       2054 s      27223 s          0 s
       
  Memory: 6.781211853027344 GB (3266.59375 MB free)
  Uptime: 559.0 sec
  Load Avg:  1.0  0.912109375  0.5234375
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake-avx512)
```
...
## Job Properties
* Time of benchmark: 13 Apr 2023 - 1:16
* Package commit: c7aabf
* Julia commit: 44fa15
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                       | 482.798 μs (5%) |           |                 |             |
...
| `["collectors", :(:comp => "map"), :(:impl => "man")]`                                      |   4.125 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "safe_coll")]`                                |  12.300 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "vec")]`                                      |  64.400 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                             | 443.986 ms (5%) | 50.552 ms | 804.14 MiB (1%) |     4024332 |
...
| `["mergewith", :(:combine => :+), :(:desttype => :compatible), :(:destkeys => :empty)]`     |  24.499 μs (5%) |           |  91.72 KiB (1%) |          14 |
...
## Job Properties
* Time of benchmark: 13 Apr 2023 - 1:18
...
| `["dataframes", "Categorical"]`                                                             | 576.078 ms (5%) | 68.461 ms | 909.14 MiB (1%) |     5335052 |
