...
* Pull request commit: [`acabe1405851c4db214b72bfcc06f2a32c35ba57`](https://github.com/JuliaFolds/BangBang.jl/commit/acabe1405851c4db214b72bfcc06f2a32c35ba57)
...
## Job Properties
* Time of benchmarks:
    - Target: 4 Jun 2023 - 01:53
    - Baseline: 4 Jun 2023 - 01:55
* Package commits:
    - Target: a25f0d
    - Baseline: d70a19
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz      30865 s          0 s       2344 s      22545 s          0 s
       #2  2593 MHz       9365 s          2 s       1470 s      44709 s          0 s
       
  Memory: 6.7812042236328125 GB (3193.125 MB free)
  Uptime: 562.0 sec
  Load Avg:  1.00634765625  0.8134765625  0.41943359375
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz      39604 s          0 s       2674 s      26964 s          0 s
       #2  2593 MHz      13992 s          2 s       1845 s      53188 s          0 s
       
  Memory: 6.7812042236328125 GB (3241.31640625 MB free)
  Uptime: 697.0 sec
  Load Avg:  1.0419921875  0.92138671875  0.5185546875
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake)
```
...
## Job Properties
* Time of benchmark: 4 Jun 2023 - 1:53
* Package commit: a25f0d
* Julia commit: 44fa15
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                       | 509.907 μs (5%) |           |                 |             |
...
| `["dataframes", "Categorical"]`                                                             | 466.239 ms (5%) | 51.472 ms | 804.14 MiB (1%) |     4024332 |
...
| `["mergewith", :(:combine => :+), :(:desttype => :compatible), :(:destkeys => :empty)]`     |  40.200 μs (5%) |           |  91.72 KiB (1%) |          14 |
...
## Job Properties
* Time of benchmark: 4 Jun 2023 - 1:55
...
| `["dataframes", "Categorical"]`                                                             | 618.118 ms (5%) | 79.853 ms | 909.14 MiB (1%) |     5335052 |
...
| `["mergewith", :(:combine => :right), :(:desttype => :compatible), :(:destkeys => :half)]`  |  31.901 μs (5%) |           |  68.34 KiB (1%) |           5 |
