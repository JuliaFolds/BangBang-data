...
* Pull request commit: [`57364ea2cc4c94b0d24e55b3b6e41933d74f47cd`](https://github.com/JuliaFolds/BangBang.jl/commit/57364ea2cc4c94b0d24e55b3b6e41933d74f47cd)
...
## Job Properties
* Time of benchmarks:
    - Target: 23 Mar 2023 - 01:20
    - Baseline: 23 Mar 2023 - 01:22
* Package commits:
    - Target: 389c16
    - Baseline: d70a19
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz      30511 s          2 s       2141 s      17391 s          0 s
       #2  2593 MHz       8571 s          1 s       1542 s      39706 s          0 s
       
  Memory: 6.781219482421875 GB (3275.13671875 MB free)
  Uptime: 505.0 sec
  Load Avg:  1.02099609375  0.91650390625  0.50439453125
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz      33953 s          2 s       2508 s      26752 s          0 s
       #2  2593 MHz      18194 s          1 s       1871 s      42960 s          0 s
       
  Memory: 6.781219482421875 GB (3246.375 MB free)
  Uptime: 637.0 sec
  Load Avg:  1.103515625  1.03564453125  0.61572265625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake)
```
...
## Job Properties
* Time of benchmark: 23 Mar 2023 - 1:20
* Package commit: 389c16
* Julia commit: 44fa15
...
| `["collectors", :(:comp => "filter"), :(:impl => "nonexpanding")]`                          |  36.700 μs (5%) |           | 312.75 KiB (1%) |        5005 |
| `["collectors", :(:comp => "filter"), :(:impl => "vec")]`                                   |  37.101 μs (5%) |           | 128.59 KiB (1%) |          13 |
| `["collectors", :(:comp => "map"), :(:impl => "coll")]`                                     |   6.350 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "man")]`                                      |   6.367 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "safe_coll")]`                                |  10.600 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "vec")]`                                      |  67.302 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                             | 467.389 ms (5%) | 55.588 ms | 804.14 MiB (1%) |     4024332 |
| `["dataframes", "Int-Int"]`                                                                 |   1.117 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                             |   1.532 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-String"]`                                                          |   1.469 ms (5%) |           | 160.27 KiB (1%) |       10252 |
...
| `["mergewith", :(:combine => :right), :(:desttype => :compatible), :(:destkeys => :half)]`  |  23.900 μs (5%) |           |                 |             |
...
## Job Properties
* Time of benchmark: 23 Mar 2023 - 1:22
...
| `["dataframes", "Categorical"]`                                                             | 599.076 ms (5%) | 71.790 ms | 909.14 MiB (1%) |     5335052 |
