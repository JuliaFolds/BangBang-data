...
* Pull request commit: [`aa60e407b801028c07beec17e38118b826d8e953`](https://github.com/JuliaFolds/BangBang.jl/commit/aa60e407b801028c07beec17e38118b826d8e953)
...
## Job Properties
* Time of benchmarks:
    - Target: 16 Mar 2023 - 01:26
    - Baseline: 16 Mar 2023 - 01:28
* Package commits:
    - Target: eabec5
    - Baseline: d70a19
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
       ...
       #1  2793 MHz       9150 s          0 s       1494 s      39144 s          0 s
       #2  2793 MHz      29262 s          2 s       1886 s      18839 s          0 s
       
  Memory: 6.781219482421875 GB (3191.6640625 MB free)
  Uptime: 504.0 sec
  Load Avg:  1.00537109375  0.927734375  0.513671875
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
              speed         user         nice          sys         idle          irq
       #1  2793 MHz      14214 s          0 s       1843 s      46587 s          0 s
       #2  2793 MHz      36924 s          2 s       2158 s      23773 s          0 s
       
  Memory: 6.781219482421875 GB (3250.296875 MB free)
  Uptime: 633.0 sec
  Load Avg:  1.11767578125  1.04638671875  0.62255859375
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake-avx512)
```
...
## Job Properties
* Time of benchmark: 16 Mar 2023 - 1:26
* Package commit: eabec5
* Julia commit: 44fa15
...
| `["collectors", :(:comp => "map"), :(:impl => "coll")]`                                     |   5.717 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "man")]`                                      |   5.283 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "safe_coll")]`                                |  12.300 μs (5%) |           |  78.20 KiB (1%) |           2 |
| `["collectors", :(:comp => "map"), :(:impl => "vec")]`                                      |  64.100 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                             | 448.320 ms (5%) | 51.985 ms | 804.14 MiB (1%) |     4024332 |
...
| `["dataframes", "String-String"]`                                                           |   1.386 ms (5%) |           | 160.27 KiB (1%) |       10252 |
...
| `["mergewith", :(:combine => :right), :(:desttype => :compatible), :(:destkeys => :half)]`  |  19.299 μs (5%) |           |  68.34 KiB (1%) |           5 |
...
## Job Properties
* Time of benchmark: 16 Mar 2023 - 1:28
...
| `["collectors", :(:comp => "filter"), :(:impl => "coll")]`                                  |  38.400 μs (5%) |           | 284.81 KiB (1%) |        5012 |
...
| `["collectors", :(:comp => "map"), :(:impl => "vec")]`                                      |  63.999 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                             | 585.380 ms (5%) | 68.259 ms | 909.14 MiB (1%) |     5335052 |
...
| `["mergewith", :(:combine => :+), :(:desttype => :compatible), :(:destkeys => :empty)]`     |  23.500 μs (5%) |           |  91.72 KiB (1%) |          14 |
...
| `["mergewith", :(:combine => :+), :(:desttype => :widen), :(:destkeys => :empty)]`          |  24.100 μs (5%) |           |  92.31 KiB (1%) |          18 |
| `["mergewith", :(:combine => :right), :(:desttype => :compatible), :(:destkeys => :empty)]` |  23.599 μs (5%) |           |  91.72 KiB (1%) |          14 |
| `["mergewith", :(:combine => :right), :(:desttype => :compatible), :(:destkeys => :equal)]` |  11.799 μs (5%) |           |                 |             |
