...
* Pull request commit: [`40b92c25ee59898d6d8b8d5aa45ccc579fae8107`](https://github.com/JuliaFolds/BangBang.jl/commit/40b92c25ee59898d6d8b8d5aa45ccc579fae8107)
...
## Job Properties
* Time of benchmarks:
    - Target: 16 Feb 2023 - 01:28
    - Baseline: 16 Feb 2023 - 01:30
* Package commits:
    - Target: 6e33f8
    - Baseline: d70a19
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
       ...
       #1  2793 MHz       6442 s          2 s       1098 s      35394 s          0 s
       #2  2793 MHz      31104 s          0 s       1658 s      10102 s          0 s
       
  Memory: 6.781219482421875 GB (3357.921875 MB free)
  Uptime: 435.0 sec
  Load Avg:  1.0  0.80322265625  0.40771484375
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
              speed         user         nice          sys         idle          irq
       #1  2793 MHz      15782 s          2 s       1483 s      38220 s          0 s
       #2  2793 MHz      34276 s          0 s       1863 s      19251 s          0 s
       
  Memory: 6.781219482421875 GB (3374.60546875 MB free)
  Uptime: 561.0 sec
  Load Avg:  1.0  0.87744140625  0.49072265625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake-avx512)
```
...
## Job Properties
* Time of benchmark: 16 Feb 2023 - 1:28
* Package commit: 6e33f8
* Julia commit: 44fa15
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                       | 492.601 μs (5%) |           |                 |             |
...
| `["collectors", :(:comp => "map"), :(:impl => "coll")]`                                     |   4.871 μs (5%) |           |  78.20 KiB (1%) |           2 |
...
| `["dataframes", "Categorical"]`                                                             | 420.317 ms (5%) | 45.109 ms | 804.14 MiB (1%) |     4024332 |
...
## Job Properties
* Time of benchmark: 16 Feb 2023 - 1:30
...
| `["dataframes", "Categorical"]`                                                             | 576.602 ms (5%) | 61.615 ms | 909.14 MiB (1%) |     5335052 |
