...
* Pull request commit: [`9f93ff1c0c3f2900edcba53b7285085bf2f0d328`](https://github.com/JuliaFolds/BangBang.jl/commit/9f93ff1c0c3f2900edcba53b7285085bf2f0d328)
...
## Job Properties
* Time of benchmarks:
    - Target: 23 Feb 2023 - 01:24
    - Baseline: 23 Feb 2023 - 01:26
* Package commits:
    - Target: 987df2
    - Baseline: d70a19
* Julia commits:
...
|-------------------------------------------------------------|------------------------------|------------------------------|
| `["append", "append!!(::Vector, ::SingletonVector)"]`       | 0.63 (5%) :white_check_mark: |                   1.00 (1%)  |
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
       ...
       #1  2793 MHz      28937 s          0 s       1731 s      32199 s          0 s
       #2  2793 MHz       8767 s          1 s       1099 s      52724 s          0 s
       
  Memory: 6.781219482421875 GB (3315.81640625 MB free)
  Uptime: 633.0 sec
  Load Avg:  1.00048828125  0.81884765625  0.43310546875
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
              speed         user         nice          sys         idle          irq
       #1  2793 MHz      32218 s          0 s       2044 s      41249 s          0 s
       #2  2793 MHz      18045 s          1 s       1367 s      55842 s          0 s
       
  Memory: 6.781219482421875 GB (3290.75 MB free)
  Uptime: 760.0 sec
  Load Avg:  1.07275390625  0.9453125  0.53564453125
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake-avx512)
```
...
## Job Properties
* Time of benchmark: 23 Feb 2023 - 1:24
* Package commit: 987df2
* Julia commit: 44fa15
...
| `["collectors", :(:comp => "map"), :(:impl => "coll")]`                                     |   3.983 μs (5%) |           |  78.20 KiB (1%) |           2 |
...
| `["dataframes", "Categorical"]`                                                             | 423.784 ms (5%) | 47.050 ms | 804.14 MiB (1%) |     4024332 |
| `["dataframes", "Int-Int"]`                                                                 |   1.096 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                             |   1.394 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-String"]`                                                          |   1.415 ms (5%) |           | 160.27 KiB (1%) |       10252 |
| `["dataframes", "String-String"]`                                                           |   1.370 ms (5%) |           | 160.27 KiB (1%) |       10252 |
| `["mergewith", :(:combine => :+), :(:desttype => :compatible), :(:destkeys => :empty)]`     |  22.199 μs (5%) |           |  91.72 KiB (1%) |          14 |
...
| `["mergewith", :(:combine => :right), :(:desttype => :compatible), :(:destkeys => :half)]`  |  17.799 μs (5%) |           |  68.34 KiB (1%) |           5 |
...
## Job Properties
* Time of benchmark: 23 Feb 2023 - 1:26
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                       | 762.389 μs (5%) |           |                 |             |
