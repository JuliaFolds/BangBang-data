...
* Pull request commit: [`01fa1fe8d6a70515371bcb7e17af268cf4471e2b`](https://github.com/JuliaFolds/BangBang.jl/commit/01fa1fe8d6a70515371bcb7e17af268cf4471e2b)
...
## Job Properties
* Time of benchmarks:
    - Target: 11 Jan 2023 - 01:25
    - Baseline: 11 Jan 2023 - 01:27
* Package commits:
    - Target: ee3209
    - Baseline: d70a19
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
       ...
       #1  2793 MHz      31471 s          3 s       2025 s      21973 s          0 s
       #2  2793 MHz       6313 s          0 s       1534 s      47423 s          0 s
       
  Memory: 6.781219482421875 GB (3344.16796875 MB free)
  Uptime: 560.0 sec
  Load Avg:  1.00439453125  0.81494140625  0.41357421875
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
              speed         user         nice          sys         idle          irq
       #1  2793 MHz      41190 s          3 s       2412 s      24427 s          0 s
       #2  2793 MHz       9137 s          0 s       1743 s      56921 s          0 s
       
  Memory: 6.781219482421875 GB (3369.609375 MB free)
  Uptime: 686.0 sec
  Load Avg:  1.0224609375  0.8984375  0.5009765625
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake-avx512)
```
...
## Job Properties
* Time of benchmark: 11 Jan 2023 - 1:25
* Package commit: ee3209
* Julia commit: 44fa15
...
| `["dataframes", "Categorical"]`                                                             | 426.994 ms (5%) | 48.084 ms | 804.14 MiB (1%) |     4024332 |
...
| `["dataframes", "String-String"]`                                                           |   1.373 ms (5%) |           | 160.27 KiB (1%) |       10252 |
...
| `["mergewith", :(:combine => :right), :(:desttype => :compatible), :(:destkeys => :empty)]` |  22.599 μs (5%) |           |  91.72 KiB (1%) |          14 |
...
## Job Properties
* Time of benchmark: 11 Jan 2023 - 1:27
...
| `["collectors", :(:comp => "filter"), :(:impl => "nonexpanding")]`                          |  32.500 μs (5%) |           | 312.75 KiB (1%) |        5005 |
...
| `["dataframes", "Categorical"]`                                                             | 588.795 ms (5%) | 70.812 ms | 909.14 MiB (1%) |     5335052 |
...
| `["mergewith", :(:combine => :right), :(:desttype => :compatible), :(:destkeys => :equal)]` |  12.199 μs (5%) |           |                 |             |
