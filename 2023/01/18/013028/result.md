...
* Pull request commit: [`1adc3458e455ad054bb06a188e9a994a52f44068`](https://github.com/JuliaFolds/BangBang.jl/commit/1adc3458e455ad054bb06a188e9a994a52f44068)
...
## Job Properties
* Time of benchmarks:
    - Target: 18 Jan 2023 - 01:27
    - Baseline: 18 Jan 2023 - 01:29
* Package commits:
    - Target: 8f347f
    - Baseline: d70a19
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
       ...
       #1  2593 MHz      32144 s          2 s       2014 s       8287 s          0 s
       #2  2593 MHz       6921 s          1 s       1584 s      33766 s          0 s
       
  Memory: 6.781219482421875 GB (3324.54296875 MB free)
  Uptime: 429.0 sec
  Load Avg:  1.0048828125  0.9736328125  0.5380859375
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8272CL CPU @ 2.60GHz: 
              speed         user         nice          sys         idle          irq
       #1  2593 MHz      43987 s          2 s       2510 s       9707 s          0 s
       #2  2593 MHz       8599 s          1 s       1833 s      45559 s          0 s
       
  Memory: 6.781219482421875 GB (3350.1015625 MB free)
  Uptime: 566.0 sec
  Load Avg:  0.99951171875  0.98681640625  0.60693359375
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake)
```
...
## Job Properties
* Time of benchmark: 18 Jan 2023 - 1:27
* Package commit: 8f347f
* Julia commit: 44fa15
...
| `["collectors", :(:comp => "filter"), :(:impl => "base")]`                                  |  36.301 μs (5%) |           | 128.66 KiB (1%) |          14 |
...
| `["collectors", :(:comp => "map"), :(:impl => "coll")]`                                     |   5.225 μs (5%) |           |  78.20 KiB (1%) |           2 |
...
| `["dataframes", "Categorical"]`                                                             | 488.052 ms (5%) | 56.325 ms | 804.14 MiB (1%) |     4024332 |
...
| `["mergewith", :(:combine => :+), :(:desttype => :compatible), :(:destkeys => :empty)]`     |  39.600 μs (5%) |           |  91.72 KiB (1%) |          14 |
...
| `["mergewith", :(:combine => :+), :(:desttype => :widen), :(:destkeys => :empty)]`          |  37.300 μs (5%) |           |  92.31 KiB (1%) |          18 |
...
## Job Properties
* Time of benchmark: 18 Jan 2023 - 1:29
...
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                       | 523.905 μs (5%) |           |                 |             |
| `["append", "append!!(Empty(SVector), ::SingletonVector)"]`                                 |  11.712 ns (5%) |           |                 |             |
| `["collectors", :(:comp => "filter"), :(:impl => "base")]`                                  |  35.001 μs (5%) |           | 128.66 KiB (1%) |          14 |
...
| `["dataframes", "Categorical"]`                                                             | 538.086 ms (5%) | 66.600 ms | 909.14 MiB (1%) |     5335052 |
...
| `["mergewith", :(:combine => :+), :(:desttype => :compatible), :(:destkeys => :half)]`      |  34.501 μs (5%) |           |  68.34 KiB (1%) |           5 |
| `["mergewith", :(:combine => :+), :(:desttype => :widen), :(:destkeys => :empty)]`          |  40.300 μs (5%) |           |  92.31 KiB (1%) |          18 |
| `["mergewith", :(:combine => :right), :(:desttype => :compatible), :(:destkeys => :empty)]` |  33.800 μs (5%) |           |  91.72 KiB (1%) |          14 |
