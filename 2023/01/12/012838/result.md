...
* Pull request commit: [`ee17bdc584d7d8dca0d0890823253817cb15accc`](https://github.com/JuliaFolds/BangBang.jl/commit/ee17bdc584d7d8dca0d0890823253817cb15accc)
...
## Job Properties
* Time of benchmarks:
    - Target: 12 Jan 2023 - 01:25
    - Baseline: 12 Jan 2023 - 01:28
* Package commits:
    - Target: fe4cd3
    - Baseline: d70a19
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
       ...
       #1  2793 MHz      31660 s          0 s       1942 s      17766 s          0 s
       #2  2793 MHz       6193 s          2 s       1462 s      43698 s          0 s
       
  Memory: 6.781219482421875 GB (3362.1328125 MB free)
  Uptime: 521.0 sec
  Load Avg:  1.07275390625  0.93896484375  0.5107421875
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
              speed         user         nice          sys         idle          irq
       #1  2793 MHz      33922 s          0 s       2138 s      28022 s          0 s
       #2  2793 MHz      16551 s          2 s       1850 s      45704 s          0 s
       
  Memory: 6.781219482421875 GB (3325.8984375 MB free)
  Uptime: 648.0 sec
  Load Avg:  1.005859375  0.96435546875  0.57763671875
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake-avx512)
```
...
## Job Properties
* Time of benchmark: 12 Jan 2023 - 1:25
* Package commit: fe4cd3
* Julia commit: 44fa15
...
| `["collectors", :(:comp => "filter"), :(:impl => "coll")]`                                  |  38.199 μs (5%) |           | 284.81 KiB (1%) |        5012 |
| `["collectors", :(:comp => "filter"), :(:impl => "nonexpanding")]`                          |  32.100 μs (5%) |           | 312.75 KiB (1%) |        5005 |
| `["collectors", :(:comp => "filter"), :(:impl => "vec")]`                                   |  34.800 μs (5%) |           | 128.59 KiB (1%) |          13 |
| `["collectors", :(:comp => "map"), :(:impl => "coll")]`                                     |   4.383 μs (5%) |           |  78.20 KiB (1%) |           2 |
...
| `["dataframes", "Categorical"]`                                                             | 427.236 ms (5%) | 49.707 ms | 804.14 MiB (1%) |     4024332 |
...
| `["mergewith", :(:combine => :+), :(:desttype => :compatible), :(:destkeys => :half)]`      |  18.799 μs (5%) |           |  68.34 KiB (1%) |           5 |
...
## Job Properties
* Time of benchmark: 12 Jan 2023 - 1:28
...
| `["collectors", :(:comp => "map"), :(:impl => "vec")]`                                      |  62.899 μs (5%) |           | 256.64 KiB (1%) |          14 |
| `["dataframes", "Categorical"]`                                                             | 572.059 ms (5%) | 65.241 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                                 |   1.096 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                             |   1.421 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-String"]`                                                          |   1.393 ms (5%) |           | 160.27 KiB (1%) |       10252 |
