...
* Pull request commit: [`b2bbe1921e749732cac26c2e6d785b4a8ad402a9`](https://github.com/JuliaFolds/BangBang.jl/commit/b2bbe1921e749732cac26c2e6d785b4a8ad402a9)
...
## Job Properties
* Time of benchmarks:
    - Target: 19 Aug 2023 - 01:04
    - Baseline: 19 Aug 2023 - 01:06
* Package commits:
    - Target: f76fa0
    - Baseline: d70a19
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
       ...
       #1  2793 MHz      30819 s          2 s       1954 s      20012 s          0 s
       #2  2793 MHz       9200 s          0 s       1798 s      41657 s          0 s
       
  Memory: 6.769481658935547 GB (3039.6484375 MB free)
  Uptime: 533.0 sec
  Load Avg:  1.146484375  0.84912109375  0.4228515625
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
              speed         user         nice          sys         idle          irq
       #1  2793 MHz      35259 s          2 s       2342 s      27840 s          0 s
       #2  2793 MHz      17372 s          0 s       2075 s      45878 s          0 s
       
  Memory: 6.769481658935547 GB (3048.52734375 MB free)
  Uptime: 660.0 sec
  Load Avg:  1.07470703125  0.92041015625  0.505859375
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake-avx512)
```
...
## Job Properties
* Time of benchmark: 19 Aug 2023 - 1:4
* Package commit: f76fa0
* Julia commit: 44fa15
...
| `["collectors", :(:comp => "map"), :(:impl => "coll")]`                                     |   4.414 μs (5%) |           |  78.20 KiB (1%) |           2 |
...
| `["dataframes", "Categorical"]`                                                             | 422.887 ms (5%) | 44.790 ms | 804.14 MiB (1%) |     4024332 |
...
## Job Properties
* Time of benchmark: 19 Aug 2023 - 1:6
...
| `["dataframes", "Categorical"]`                                                             | 570.018 ms (5%) | 59.638 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                                 |   1.125 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                             |   1.372 ms (5%) |           | 160.23 KiB (1%) |       10251 |
