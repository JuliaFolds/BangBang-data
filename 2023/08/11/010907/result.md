...
* Pull request commit: [`55fa714c5e6635f28de6cd264ab9cf16bbdf00bc`](https://github.com/JuliaFolds/BangBang.jl/commit/55fa714c5e6635f28de6cd264ab9cf16bbdf00bc)
...
## Job Properties
* Time of benchmarks:
    - Target: 11 Aug 2023 - 01:06
    - Baseline: 11 Aug 2023 - 01:08
* Package commits:
    - Target: 5023ef
    - Baseline: d70a19
* Julia commits:
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
       ...
       #1  2793 MHz      19764 s          0 s       1988 s      33243 s          0 s
       #2  2793 MHz      20002 s          2 s       1896 s      33012 s          0 s
       
  Memory: 6.769481658935547 GB (3220.3984375 MB free)
  Uptime: 556.0 sec
  Load Avg:  1.0  0.8701171875  0.48486328125
  WORD_SIZE: 64
  LIBM: libopenlibm
...
Platform Info:
  ...
  CPU: Intel(R) Xeon(R) Platinum 8370C CPU @ 2.80GHz: 
              speed         user         nice          sys         idle          irq
       #1  2793 MHz      24100 s          0 s       2363 s      41474 s          0 s
       #2  2793 MHz      28430 s          2 s       2195 s      37247 s          0 s
       
  Memory: 6.769481658935547 GB (3265.92578125 MB free)
  Uptime: 686.0 sec
  Load Avg:  1.04296875  0.947265625  0.56787109375
  WORD_SIZE: 64
  LIBM: libopenlibm
  LLVM: libLLVM-8.0.1 (ORCJIT, skylake-avx512)
```
...
## Job Properties
* Time of benchmark: 11 Aug 2023 - 1:6
* Package commit: 5023ef
* Julia commit: 44fa15
...
|---------------------------------------------------------------------------------------------|----------------:|----------:|----------------:|------------:|
| `["append", "append!!(::SVector, ::SingletonVector)"]`                                      |  12.813 ns (5%) |           |                 |             |
| `["append", "append!!(::Vector, ::SingletonVector)"]`                                       | 488.803 μs (5%) |           |                 |             |
...
| `["dataframes", "Categorical"]`                                                             | 441.789 ms (5%) | 49.836 ms | 804.14 MiB (1%) |     4024332 |
...
## Job Properties
* Time of benchmark: 11 Aug 2023 - 1:8
...
| `["dataframes", "Categorical"]`                                                             | 568.921 ms (5%) | 63.200 ms | 909.14 MiB (1%) |     5335052 |
| `["dataframes", "Int-Int"]`                                                                 |   1.090 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-Int"]`                                                             |   1.406 ms (5%) |           | 160.23 KiB (1%) |       10251 |
| `["dataframes", "Missing-String"]`                                                          |   1.408 ms (5%) |           | 160.27 KiB (1%) |       10252 |
...
| `["mergewith", :(:combine => :+), :(:desttype => :compatible), :(:destkeys => :half)]`      |  18.101 μs (5%) |           |  68.34 KiB (1%) |           5 |
| `["mergewith", :(:combine => :+), :(:desttype => :widen), :(:destkeys => :empty)]`          |  22.300 μs (5%) |           |  92.31 KiB (1%) |          18 |
